...
CreateStoragePolicy202Response
#>
function New-StoragePolicy {
    ...
    Param (
        ...
        [PSCustomObject]
        ${DatapoliciesV41ConfigStoragePolicy},
        [Switch]
        $NoHttpInfo
    )
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/storage-policies'

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling createStoragePolicy."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId

        if (!$DatapoliciesV41ConfigStoragePolicy) {
            throw "Error! The required parameter `DatapoliciesV41ConfigStoragePolicy` missing when calling createStoragePolicy."
        }
...
Delete an existing Storage Policy
...
DeleteStoragePolicyById202Response
#>
function Invoke-DeleteStoragePolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/storage-policies/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling deleteStoragePolicyById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$IfMatch) {
            throw "Error! The required parameter `IfMatch` missing when calling deleteStoragePolicyById."
        }
        $LocalVarHeaderParameters['If-Match'] = $IfMatch

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling deleteStoragePolicyById."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId
...
Get a Storage Policy based on external identifier
...
GetStoragePolicyById200Response
#>
function Get-StoragePolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/storage-policies/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getStoragePolicyById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))
...
ListStoragePolicies200Response
#>
...
UpdateStoragePolicyById202Response
#>
function Update-StoragePolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/storage-policies/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling updateStoragePolicyById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$IfMatch) {
            throw "Error! The required parameter `IfMatch` missing when calling updateStoragePolicyById."
        }
        $LocalVarHeaderParameters['If-Match'] = $IfMatch

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling updateStoragePolicyById."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId

        if (!$DatapoliciesV41ConfigStoragePolicy) {
            throw "Error! The required parameter `DatapoliciesV41ConfigStoragePolicy` missing when calling updateStoragePolicyById."
        }

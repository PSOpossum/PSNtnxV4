...
ListClusterCapabilities200Response
#>
function Invoke-ListClusterCapabilities {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/config/capabilities'
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "ListClusterCapabilities200Response" `

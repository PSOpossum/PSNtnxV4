...
function Get-OperationById {
    ...
    Process {
        ...
        $LocalVarUri = '/iam/v4.1.b1/authz/operations/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getOperationById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "GetOperationById200Response" `
...
#>
function Invoke-ListOperations {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        ...
        $LocalVarUri = '/iam/v4.1.b1/authz/operations'
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListOperations200Response" `
			-IsBodyNullable $false

...
.PARAMETER IamV41B1AuthnUserGroup
Information for the create user group request. It includes fields like name, groupType, idpId, etc.
...
function New-UserGroup {
    ...
    Process {
        ...
        $LocalVarUri = '/iam/v4.1.b1/authn/user-groups'

        if (!$IamV41B1AuthnUserGroup) {
            throw "Error! The required parameter `IamV41B1AuthnUserGroup` missing when calling createUserGroup."
        }

        $LocalVarBodyParameter = $IamV41B1AuthnUserGroup | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "CreateUserGroup201Response" `
...
None
#>
function Invoke-DeleteUserGroupById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/iam/v4.1.b1/authn/user-groups/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling deleteUserGroupById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$IfMatch) {
            throw "Error! The required parameter `IfMatch` missing when calling deleteUserGroupById."
        }
...
GetUserGroupById200Response
#>
function Get-UserGroupById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/iam/v4.1.b1/authn/user-groups/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getUserGroupById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "GetUserGroupById200Response" `
                                -IsBodyNullable $false
...
function Invoke-ListUserGroups {
    ...
    Process {
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "ListUserGroups200Response" `
                                -IsBodyNullable $false

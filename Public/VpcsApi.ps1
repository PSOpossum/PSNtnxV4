...
.PARAMETER NetworkingV41ConfigVpc
Request schema to create the VPC.
...
function New-Vpc {
    ...
    Param (
        ...
        [PSCustomObject]
        ${NetworkingV41ConfigVpc},
        [Switch]
        $NoHttpInfo
    )

    Process {
        'Calling method: New-Vpc' | Write-Debug
        ...
        $LocalVarUri = '/networking/v4.1/config/vpcs'

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling createVpc."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId

        if (!$NetworkingV41ConfigVpc) {
            throw "Error! The required parameter `NetworkingV41ConfigVpc` missing when calling createVpc."
        }

        $LocalVarBodyParameter = $NetworkingV41ConfigVpc | ConvertTo-Json -Depth 100
...
function Invoke-DeleteVpcById {
    ...
    Process {
        'Calling method: Invoke-DeleteVpcById' | Write-Debug
		$PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/networking/v4.1/config/vpcs/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling deleteVpcById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling deleteVpcById."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId
...
GetVpcById200Response
#>
function Get-VpcById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-VpcById' | Write-Debug
		$PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/networking/v4.1/config/vpcs/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getVpcById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "GetVpcById200Response" `
			-IsBodyNullable $false
...
GetVpcNsStats200Response
#>
function Get-VpcNsStats {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Get-VpcNsStats' | Write-Debug
		$PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/networking/v4.1/stats/vpc/{vpcExtId}/external-subnets/{extId}'
        if (!$VpcExtId) {
            throw "Error! The required parameter `VpcExtId` missing when calling getVpcNsStats."
        }
        $LocalVarUri = $LocalVarUri.replace('{vpcExtId}', [System.Web.HTTPUtility]::UrlEncode($VpcExtId))
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getVpcNsStats."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$StartTime) {
            throw "Error! The required parameter `StartTime` missing when calling getVpcNsStats."
        }
        $LocalVarQueryParameters['$startTime'] = $StartTime

        if (!$EndTime) {
            throw "Error! The required parameter `EndTime` missing when calling getVpcNsStats."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "GetVpcNsStats200Response" `
			-IsBodyNullable $false
...
function Invoke-ListVpcs {
    ...
    Process {
        'Calling method: Invoke-ListVpcs' | Write-Debug
		$PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListVpcs200Response" `
			-IsBodyNullable $false
...
.PARAMETER NetworkingV41ConfigVpc
Request schema to update the specified VPC.
...
function Update-VpcById {
    ...
    Process {
        'Calling method: Update-VpcById' | Write-Debug
		$PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/networking/v4.1/config/vpcs/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling updateVpcById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$IfMatch) {
            throw "Error! The required parameter `IfMatch` missing when calling updateVpcById."
        }
        $LocalVarHeaderParameters['If-Match'] = $IfMatch

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling updateVpcById."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId

        if (!$NetworkingV41ConfigVpc) {
            throw "Error! The required parameter `NetworkingV41ConfigVpc` missing when calling updateVpcById."
        }

...
GetEntitySyncPolicyById200Response
#>
function Get-EntitySyncPolicyById {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/entity-sync-policies/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getEntitySyncPolicyById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "GetEntitySyncPolicyById200Response" `
...
ListEntitySyncPolicies200Response
#>
function Invoke-ListEntitySyncPolicies {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/entity-sync-policies'
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListEntitySyncPolicies200Response" `
			-IsBodyNullable $false
...
Sync entity identified by its identifier to a remote domain manager
...
SyncEntitySyncPolicyById202Response
#>
function Sync-EntitySyncPolicyById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/datapolicies/v4.1/config/entity-sync-policies/{extId}/$actions/sync-entity'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling syncEntitySyncPolicyById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling syncEntitySyncPolicyById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'POST' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "SyncEntitySyncPolicyById202Response" `
			-IsBodyNullable $false

...
function Get-EntityById {
    ...
    Process {
        ...
        $LocalVarUri = '/lifecycle/v4.1/resources/entities/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getEntityById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "GetEntityById200Response" `
...
function Invoke-ListEntities {
    ...
    Process {
        ...
        $LocalVarUri = '/lifecycle/v4.1/resources/entities'
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListEntities200Response" `
			-IsBodyNullable $false
...
.PARAMETER LifecycleV41CommonPreloadSpec
No description available.
...
PreloadArtifacts202Response
#>
function Invoke-PreloadArtifacts {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/lifecycle/v4.1/operations/$actions/preload-artifacts'

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling preloadArtifacts."
        }
        ...
        if (!$LifecycleV41CommonPreloadSpec) {
            throw "Error! The required parameter `LifecycleV41CommonPreloadSpec` missing when calling preloadArtifacts."
        }

        $LocalVarBodyParameter = $LifecycleV41CommonPreloadSpec | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Send-ApiRequest -Method 'POST' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "PreloadArtifacts202Response" `
			-IsBodyNullable $false

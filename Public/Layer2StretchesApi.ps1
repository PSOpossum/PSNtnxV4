...
function New-Layer2Stretch {
    ...
    Param (
        ...
        [PSCustomObject]
        ${NetworkingV41ConfigLayer2Stretch},
        [Switch]
        $NoHttpInfo
    )
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/config/layer2-stretches'

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling createLayer2Stretch."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId

        if (!$NetworkingV41ConfigLayer2Stretch) {
            throw "Error! The required parameter `NetworkingV41ConfigLayer2Stretch` missing when calling createLayer2Stretch."
        }
...
CreateBgpSession202Response
#>
function Invoke-DeleteLayer2StretchById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/config/layer2-stretches/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling deleteLayer2StretchById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling deleteLayer2StretchById."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId
...
GetLayer2StretchById200Response
#>
function Get-Layer2StretchById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/config/layer2-stretches/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getLayer2StretchById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))
...
GetLayer2StretchStats200Response
#>
function Get-Layer2StretchStats {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/stats/layer2-stretches/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getLayer2StretchStats."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$StartTime) {
            throw "Error! The required parameter `StartTime` missing when calling getLayer2StretchStats."
        }
        $LocalVarQueryParameters['$startTime'] = $StartTime

        if (!$EndTime) {
            throw "Error! The required parameter `EndTime` missing when calling getLayer2StretchStats."
        }
...
ListLayer2Stretches200Response
#>
function Invoke-ListLayer2Stretches {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.Nullable[Int32]]
...
CreateBgpSession202Response
#>
function Update-Layer2StretchById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/config/layer2-stretches/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling updateLayer2StretchById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$IfMatch) {
            throw "Error! The required parameter `IfMatch` missing when calling updateLayer2StretchById."
        }
        $LocalVarHeaderParameters['If-Match'] = $IfMatch

        if (!$NTNXRequestId) {
            throw "Error! The required parameter `NTNXRequestId` missing when calling updateLayer2StretchById."
        }
        $LocalVarHeaderParameters['NTNX-Request-Id'] = $NTNXRequestId

        if (!$NetworkingV41ConfigLayer2Stretch) {
            throw "Error! The required parameter `NetworkingV41ConfigLayer2Stretch` missing when calling updateLayer2StretchById."
        }

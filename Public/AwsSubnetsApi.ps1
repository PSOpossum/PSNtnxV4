...
ListAwsSubnets200Response
#>
function Invoke-ListAwsSubnets {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        $LocalVarUri = '/networking/v4.1/aws/config/subnets'

        if (!$XClusterId) {
            throw "Error! The required parameter `XClusterId` missing when calling listAwsSubnets."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "ListAwsSubnets200Response" `

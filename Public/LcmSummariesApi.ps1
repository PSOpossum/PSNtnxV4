...
GetLcmSummaryById200Response
#>
function Get-LcmSummaryById {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        $LocalVarUri = '/lifecycle/v4.1/resources/lcm-summaries/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getLcmSummaryById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "GetLcmSummaryById200Response" `
...
ListLcmSummaries200Response
#>
function Invoke-ListLcmSummaries {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        ...
        $LocalVarUri = '/lifecycle/v4.1/resources/lcm-summaries'
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListLcmSummaries200Response" `
			-IsBodyNullable $false

...
function Get-EventById {
    ...
    Process {
        ...
        $LocalVarUri = '/monitoring/v4.1/serviceability/events/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getEventById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "GetEventById200Response" `
...
function Invoke-ListEvents {
    ...
    Process {
        ...
        $LocalVarUri = '/monitoring/v4.1/serviceability/events'
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListEvents200Response" `
			-IsBodyNullable $false

...
GetDiskStatsById200Response
#>
function Get-DiskStatsById {
    [CmdletBinding()]
    Param (
    ...
    Process {
        ...
        $LocalVarUri = '/vmm/v4.1/ahv/stats/vms/{vmExtId}/disks/{extId}'
        if (!$VmExtId) {
            throw "Error! The required parameter `VmExtId` missing when calling getDiskStatsById."
        }
        $LocalVarUri = $LocalVarUri.replace('{vmExtId}', [System.Web.HTTPUtility]::UrlEncode($VmExtId))
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getDiskStatsById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$StartTime) {
            throw "Error! The required parameter `StartTime` missing when calling getDiskStatsById."
        }
        $LocalVarQueryParameters['$startTime'] = $StartTime

        if (!$EndTime) {
            throw "Error! The required parameter `EndTime` missing when calling getDiskStatsById."
        }
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-ReturnType "GetDiskStatsById200Response" `
...
GetNicStatsById200Response
#>
function Get-NicStatsById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/vmm/v4.1/ahv/stats/vms/{vmExtId}/nics/{extId}'
        if (!$VmExtId) {
            throw "Error! The required parameter `VmExtId` missing when calling getNicStatsById."
        }
        $LocalVarUri = $LocalVarUri.replace('{vmExtId}', [System.Web.HTTPUtility]::UrlEncode($VmExtId))
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getNicStatsById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$StartTime) {
            throw "Error! The required parameter `StartTime` missing when calling getNicStatsById."
        }
        $LocalVarQueryParameters['$startTime'] = $StartTime

        if (!$EndTime) {
            throw "Error! The required parameter `EndTime` missing when calling getNicStatsById."
        }
        $LocalVarQueryParameters['$endTime'] = $EndTime
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "GetNicStatsById200Response" `
			-IsBodyNullable $false
...
GetVmStatsById200Response
#>
function Get-VmStatsById {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        ...
        $LocalVarUri = '/vmm/v4.1/ahv/stats/vms/{extId}'
        if (!$ExtId) {
            throw "Error! The required parameter `ExtId` missing when calling getVmStatsById."
        }
        $LocalVarUri = $LocalVarUri.replace('{extId}', [System.Web.HTTPUtility]::UrlEncode($ExtId))

        if (!$StartTime) {
            throw "Error! The required parameter `StartTime` missing when calling getVmStatsById."
        }
        $LocalVarQueryParameters['$startTime'] = $StartTime

        if (!$EndTime) {
            throw "Error! The required parameter `EndTime` missing when calling getVmStatsById."
        }
        $LocalVarQueryParameters['$endTime'] = $EndTime
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "GetVmStatsById200Response" `
			-IsBodyNullable $false
...
ListVmStats200Response
#>
function Invoke-ListVmStats {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [System.DateTime]
    ...
    Process {
        ...
        $LocalVarUri = '/vmm/v4.1/ahv/stats/vms'

        if (!$StartTime) {
            throw "Error! The required parameter `StartTime` missing when calling listVmStats."
        }
        $LocalVarQueryParameters['$startTime'] = $StartTime

        if (!$EndTime) {
            throw "Error! The required parameter `EndTime` missing when calling listVmStats."
        }
        $LocalVarQueryParameters['$endTime'] = $EndTime
        ...
        $LocalVarResult = Send-ApiRequest -Method 'GET' `
			...
			-FormParameters $LocalVarFormParameters `
			-CookieParameters $LocalVarCookieParameters `
			-ReturnType "ListVmStats200Response" `
			-IsBodyNullable $false

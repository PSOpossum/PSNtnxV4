...
function Initialize-CommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ResponseApiResponseMetadata' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ResponseApiResponseMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

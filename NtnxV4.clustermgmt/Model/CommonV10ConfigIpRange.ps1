...
function Initialize-NtnxV4CommonV10ConfigIpRange {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigIpRange' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigIpRange {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigIpRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CommonV10ConfigIpRange

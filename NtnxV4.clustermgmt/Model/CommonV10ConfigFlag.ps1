...
function Initialize-NtnxV4CommonV10ConfigFlag {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigFlag' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigFlag {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigFlag' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

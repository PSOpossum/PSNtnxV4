...
function Initialize-NtnxV4DeleteRsyslogServerById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4DeleteRsyslogServerById4XXResponse' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToDeleteRsyslogServerById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4DeleteRsyslogServerById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteRsyslogServerById4XXResponse

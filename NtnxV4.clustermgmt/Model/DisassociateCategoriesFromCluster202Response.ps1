...
function Initialize-DisassociateCategoriesFromCluster202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4DisassociateCategoriesFromCluster202Response' | Write-Debug
...
Convert from JSON to DisassociateCategoriesFromCluster202Response<PSCustomObject>
...
function ConvertFrom-JsonToDisassociateCategoriesFromCluster202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4DisassociateCategoriesFromCluster202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DisassociateCategoriesFromCluster202Response

...
function Initialize-NtnxV4CommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ResponseExternalizableAbstractModel' | Write-Debug
...
Convert from JSON to CommonV10ResponseExternalizableAbstractModel<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ResponseExternalizableAbstractModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

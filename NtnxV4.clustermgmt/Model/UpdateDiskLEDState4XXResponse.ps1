...
function Initialize-NtnxV4UpdateDiskLEDState4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4UpdateDiskLEDState4XXResponse' | Write-Debug
...
Convert from JSON to UpdateDiskLEDState4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToUpdateDiskLEDState4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4UpdateDiskLEDState4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateDiskLEDState4XXResponse

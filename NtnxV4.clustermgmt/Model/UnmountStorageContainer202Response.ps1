...
function Initialize-NtnxV4UnmountStorageContainer202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4UnmountStorageContainer202Response' | Write-Debug
...
Convert from JSON to UnmountStorageContainer202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToUnmountStorageContainer202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4UnmountStorageContainer202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UnmountStorageContainer202Response

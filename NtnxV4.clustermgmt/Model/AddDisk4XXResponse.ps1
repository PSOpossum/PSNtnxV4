...
function Initialize-NtnxV4AddDisk4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4AddDisk4XXResponse' | Write-Debug
...
Convert from JSON to AddDisk4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToAddDisk4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4AddDisk4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4AddDisk4XXResponse

...
function Initialize-NtnxV4UpdateBmcInfo202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4UpdateBmcInfo202Response' | Write-Debug
...
Convert from JSON to UpdateBmcInfo202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToUpdateBmcInfo202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4UpdateBmcInfo202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateBmcInfo202Response

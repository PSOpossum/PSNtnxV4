...
function Initialize-NtnxV4ClustermgmtV41ConfigGetBmcInfoResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ClustermgmtV41ConfigGetBmcInfoResponse' | Write-Debug
...
Convert from JSON to ClustermgmtV41ConfigGetBmcInfoResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToClustermgmtV41ConfigGetBmcInfoResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ClustermgmtV41ConfigGetBmcInfoResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ClustermgmtV41ConfigGetBmcInfoResponse

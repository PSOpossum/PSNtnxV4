...
function Initialize-CheckHypervisorRequirements202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CheckHypervisorRequirements202Response' | Write-Debug
...
Convert from JSON to CheckHypervisorRequirements202Response<PSCustomObject>
...
function ConvertFrom-JsonToCheckHypervisorRequirements202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CheckHypervisorRequirements202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CheckHypervisorRequirements202Response

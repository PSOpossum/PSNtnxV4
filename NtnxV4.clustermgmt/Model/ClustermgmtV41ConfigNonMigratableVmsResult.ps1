...
function Initialize-NtnxV4ClustermgmtV41ConfigNonMigratableVmsResult {
    ...
    Process {
        ...
        if (!$Vms -and $Vms.length -gt 1024) {
            throw "invalid value for 'Vms', number of items must be less than or equal to 1024."
        }
...
Convert from JSON to ClustermgmtV41ConfigNonMigratableVmsResult<PSCustomObject>

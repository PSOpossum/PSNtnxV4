...
function Initialize-NtnxV4DeleteSnmpTrapById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4DeleteSnmpTrapById4XXResponse' | Write-Debug
...
Convert from JSON to DeleteSnmpTrapById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDeleteSnmpTrapById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4DeleteSnmpTrapById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteSnmpTrapById4XXResponse

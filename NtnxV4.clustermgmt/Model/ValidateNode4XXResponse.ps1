...
function Initialize-NtnxV4ValidateNode4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ValidateNode4XXResponse' | Write-Debug
...
Convert from JSON to ValidateNode4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToValidateNode4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ValidateNode4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ValidateNode4XXResponse

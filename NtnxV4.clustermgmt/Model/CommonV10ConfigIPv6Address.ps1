...
function Initialize-NtnxV4CommonV10ConfigIPv6Address {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigIPv6Address' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigIPv6Address {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigIPv6Address' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

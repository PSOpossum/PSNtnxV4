...
function Initialize-NtnxV4ApplyClusterProfile202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ApplyClusterProfile202Response' | Write-Debug
...
Convert from JSON to ApplyClusterProfile202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToApplyClusterProfile202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ApplyClusterProfile202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ApplyClusterProfile202Response

...
function Initialize-CommonV10ConfigIPAddressOrFQDN {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigIPAddressOrFQDN' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIPAddressOrFQDN {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4CommonV10ConfigIPAddressOrFQDN' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

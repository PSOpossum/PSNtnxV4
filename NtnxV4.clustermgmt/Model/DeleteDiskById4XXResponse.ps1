...
function Initialize-NtnxV4DeleteDiskById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4DeleteDiskById4XXResponse' | Write-Debug
...
Convert from JSON to DeleteDiskById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDeleteDiskById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4DeleteDiskById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteDiskById4XXResponse

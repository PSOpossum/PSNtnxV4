...
function Initialize-RemoveNode202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4RemoveNode202Response' | Write-Debug
...
Convert from JSON to RemoveNode202Response<PSCustomObject>
...
function ConvertFrom-JsonToRemoveNode202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4RemoveNode202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4RemoveNode202Response

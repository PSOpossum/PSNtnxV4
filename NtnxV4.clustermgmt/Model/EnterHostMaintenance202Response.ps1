...
function Initialize-EnterHostMaintenance202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4EnterHostMaintenance202Response' | Write-Debug
...
Convert from JSON to EnterHostMaintenance202Response<PSCustomObject>
...
function ConvertFrom-JsonToEnterHostMaintenance202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4EnterHostMaintenance202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4EnterHostMaintenance202Response

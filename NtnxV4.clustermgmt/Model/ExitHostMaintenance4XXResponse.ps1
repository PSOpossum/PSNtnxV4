...
function Initialize-NtnxV4ExitHostMaintenance4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ExitHostMaintenance4XXResponse' | Write-Debug
...
Convert from JSON to ExitHostMaintenance4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToExitHostMaintenance4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ExitHostMaintenance4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ExitHostMaintenance4XXResponse

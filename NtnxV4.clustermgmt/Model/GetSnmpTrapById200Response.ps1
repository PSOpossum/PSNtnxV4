...
function Initialize-NtnxV4GetSnmpTrapById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetSnmpTrapById200Response' | Write-Debug
...
Convert from JSON to GetSnmpTrapById200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetSnmpTrapById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetSnmpTrapById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetSnmpTrapById200Response

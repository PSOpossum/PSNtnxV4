...
function Initialize-NtnxV4GetSnmpConfigByClusterId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetSnmpConfigByClusterId4XXResponse' | Write-Debug
...
Convert from JSON to GetSnmpConfigByClusterId4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetSnmpConfigByClusterId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetSnmpConfigByClusterId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetSnmpConfigByClusterId4XXResponse

...
function Initialize-NtnxV4ClustermgmtV41ConfigListPhysicalGpuProfilesApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ClustermgmtV41ConfigListPhysicalGpuProfilesApiResponse' | Write-Debug
...
Convert from JSON to ClustermgmtV41ConfigListPhysicalGpuProfilesApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToClustermgmtV41ConfigListPhysicalGpuProfilesApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ClustermgmtV41ConfigListPhysicalGpuProfilesApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ClustermgmtV41ConfigListPhysicalGpuProfilesApiResponse

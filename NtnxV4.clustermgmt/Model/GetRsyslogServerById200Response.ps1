...
function Initialize-NtnxV4GetRsyslogServerById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetRsyslogServerById200Response' | Write-Debug
...
Convert from JSON to GetRsyslogServerById200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetRsyslogServerById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetRsyslogServerById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetRsyslogServerById200Response

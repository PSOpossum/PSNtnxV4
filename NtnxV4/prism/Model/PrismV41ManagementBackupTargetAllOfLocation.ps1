...
function Initialize-PrismV41ManagementBackupTargetAllOfLocation {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ManagementBackupTargetAllOfLocation' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ManagementBackupTargetAllOfLocation {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ManagementBackupTargetAllOfLocation' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41ManagementBackupTargetAllOfLocation

...
function Initialize-DeleteBackupTargetById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4DeleteBackupTargetById202Response' | Write-Debug
...
Convert from JSON to DeleteBackupTargetById202Response<PSCustomObject>
...
function ConvertFrom-JsonToDeleteBackupTargetById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4DeleteBackupTargetById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteBackupTargetById202Response

...
function Initialize-DeleteBackupTargetById202Response {
    ...
    Process {
        'Creating PSCustomObject: prism => DeleteBackupTargetById202Response' | Write-Debug
...
function ConvertFrom-JsonToDeleteBackupTargetById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => DeleteBackupTargetById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteBackupTargetById202Response

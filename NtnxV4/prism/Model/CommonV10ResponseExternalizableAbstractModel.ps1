...
function Initialize-CommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Creating PSCustomObject: prism => CommonV10ResponseExternalizableAbstractModel' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => CommonV10ResponseExternalizableAbstractModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

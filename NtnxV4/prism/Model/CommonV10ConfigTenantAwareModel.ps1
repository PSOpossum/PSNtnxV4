...
function Initialize-CommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Creating PSCustomObject: prism => CommonV10ConfigTenantAwareModel' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => CommonV10ConfigTenantAwareModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-CommonV10ConfigIPAddressOrFQDN {
    ...
    Process {
        'Creating PSCustomObject: prism => CommonV10ConfigIPAddressOrFQDN' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIPAddressOrFQDN {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => CommonV10ConfigIPAddressOrFQDN' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

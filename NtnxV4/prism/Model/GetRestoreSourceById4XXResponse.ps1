...
function Initialize-GetRestoreSourceById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => GetRestoreSourceById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetRestoreSourceById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => GetRestoreSourceById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetRestoreSourceById4XXResponse

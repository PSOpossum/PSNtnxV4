...
function Initialize-PrismV41ConfigCategoryOld {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ConfigCategoryOld' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ConfigCategoryOld {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ConfigCategoryOld' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41ConfigCategoryOld

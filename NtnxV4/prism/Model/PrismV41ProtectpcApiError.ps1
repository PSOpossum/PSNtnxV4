...
function Initialize-PrismV41ProtectpcApiError {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41ProtectpcApiError' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ProtectpcApiError {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41ProtectpcApiError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41ProtectpcApiError

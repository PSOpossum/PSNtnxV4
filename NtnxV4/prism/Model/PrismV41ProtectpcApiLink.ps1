...
function Initialize-PrismV41ProtectpcApiLink {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41ProtectpcApiLink' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ProtectpcApiLink {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41ProtectpcApiLink' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41ProtectpcApiLink

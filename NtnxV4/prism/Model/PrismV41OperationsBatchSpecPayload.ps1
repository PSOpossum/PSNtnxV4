...
function Initialize-PrismV41OperationsBatchSpecPayload {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41OperationsBatchSpecPayload' | Write-Debug
...
function ConvertFrom-JsonToPrismV41OperationsBatchSpecPayload {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41OperationsBatchSpecPayload' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41OperationsBatchSpecPayload

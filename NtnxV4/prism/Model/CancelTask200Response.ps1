...
function Initialize-CancelTask200Response {
    ...
    Process {
        'Creating PSCustomObject: prism => CancelTask200Response' | Write-Debug
...
function ConvertFrom-JsonToCancelTask200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => CancelTask200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CancelTask200Response

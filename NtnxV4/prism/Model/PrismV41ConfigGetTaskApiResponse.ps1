...
function Initialize-PrismV41ConfigGetTaskApiResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41ConfigGetTaskApiResponse' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ConfigGetTaskApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41ConfigGetTaskApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41ConfigGetTaskApiResponse

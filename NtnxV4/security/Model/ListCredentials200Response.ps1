...
function Initialize-ListCredentials200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4ListCredentials200Response' | Write-Debug
...
Convert from JSON to ListCredentials200Response<PSCustomObject>
...
function ConvertFrom-JsonToListCredentials200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4ListCredentials200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListCredentials200Response

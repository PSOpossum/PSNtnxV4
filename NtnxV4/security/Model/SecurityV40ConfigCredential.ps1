...
function Initialize-SecurityV40ConfigCredential {
    ...
    Process {
        ...
        if ($null -eq $CredentialDetails) {
            throw "invalid value for 'CredentialDetails', 'CredentialDetails' cannot be null."
        }
...
Convert from JSON to SecurityV40ConfigCredential<PSCustomObject>
...
function ConvertFrom-JsonToSecurityV40ConfigCredential {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "credentialDetails"))) {
            throw "Error! JSON cannot be serialized due to the required property 'credentialDetails' missing."
        } else {
            $CredentialDetails = $JsonParameters.PSobject.Properties["credentialDetails"].value
        }

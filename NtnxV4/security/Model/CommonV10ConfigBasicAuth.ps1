...
function Initialize-CommonV10ConfigBasicAuth {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigBasicAuth' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigBasicAuth {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigBasicAuth' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

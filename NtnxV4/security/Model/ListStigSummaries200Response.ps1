...
function Initialize-ListStigSummaries200Response {
    ...
    Process {
        'Creating PSCustomObject: security => ListStigSummaries200Response' | Write-Debug
...
function ConvertFrom-JsonToListStigSummaries200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => ListStigSummaries200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListStigSummaries200Response

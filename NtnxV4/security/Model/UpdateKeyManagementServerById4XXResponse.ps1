...
function Initialize-UpdateKeyManagementServerById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4UpdateKeyManagementServerById4XXResponse' | Write-Debug
...
Convert from JSON to UpdateKeyManagementServerById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToUpdateKeyManagementServerById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4UpdateKeyManagementServerById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateKeyManagementServerById4XXResponse

...
function Initialize-PrismV41ConfigTaskReference {
    ...
    Process {
        'Creating PSCustomObject: security => PrismV41ConfigTaskReference' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ConfigTaskReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => PrismV41ConfigTaskReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

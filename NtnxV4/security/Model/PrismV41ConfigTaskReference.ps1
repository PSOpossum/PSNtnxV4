...
function Initialize-PrismV41ConfigTaskReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4PrismV41ConfigTaskReference' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ConfigTaskReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4PrismV41ConfigTaskReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

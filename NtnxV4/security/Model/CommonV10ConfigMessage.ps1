...
function Initialize-CommonV10ConfigMessage {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigMessage' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigMessage {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

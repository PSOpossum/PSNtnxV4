...
function Initialize-CommonV10ConfigKVPair {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigKVPair' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigKVPair {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigKVPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

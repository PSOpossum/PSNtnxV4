...
function Initialize-GetCredentialById200Response {
    ...
    Process {
        'Creating PSCustomObject: security => GetCredentialById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetCredentialById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => GetCredentialById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetCredentialById200Response

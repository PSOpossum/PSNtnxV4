...
function Initialize-GetCredentialById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4GetCredentialById200Response' | Write-Debug
...
Convert from JSON to GetCredentialById200Response<PSCustomObject>
...
function ConvertFrom-JsonToGetCredentialById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4GetCredentialById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetCredentialById200Response

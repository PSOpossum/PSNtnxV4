...
function Initialize-CommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Creating PSCustomObject: security => CommonV10ConfigTenantAwareModel' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => CommonV10ConfigTenantAwareModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

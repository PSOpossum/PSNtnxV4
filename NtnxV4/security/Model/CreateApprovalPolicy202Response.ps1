...
function Initialize-CreateApprovalPolicy202Response {
    ...
    Process {
        'Creating PSCustomObject: security => CreateApprovalPolicy202Response' | Write-Debug
...
function ConvertFrom-JsonToCreateApprovalPolicy202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => CreateApprovalPolicy202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateApprovalPolicy202Response

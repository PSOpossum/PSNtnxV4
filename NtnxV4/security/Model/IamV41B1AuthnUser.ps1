...
function Initialize-IamV41B1AuthnUser {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4IamV41B1AuthnUser' | Write-Debug
...
function ConvertFrom-JsonToIamV41B1AuthnUser {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4IamV41B1AuthnUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-IamV41B1AuthnUser {
    ...
    Process {
        'Creating PSCustomObject: security => IamV41B1AuthnUser' | Write-Debug
...
function ConvertFrom-JsonToIamV41B1AuthnUser {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => IamV41B1AuthnUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IamV41B1AuthnUser

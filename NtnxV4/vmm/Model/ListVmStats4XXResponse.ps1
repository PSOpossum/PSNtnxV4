...
function Initialize-ListVmStats4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListVmStats4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListVmStats4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListVmStats4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListVmStats4XXResponse

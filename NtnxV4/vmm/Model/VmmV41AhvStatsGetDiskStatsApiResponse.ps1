...
function Initialize-VmmV41AhvStatsGetDiskStatsApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvStatsGetDiskStatsApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvStatsGetDiskStatsApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvStatsGetDiskStatsApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvStatsGetDiskStatsApiResponse

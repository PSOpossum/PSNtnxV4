...
function Initialize-CancelGuestUpdate4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => CancelGuestUpdate4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToCancelGuestUpdate4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CancelGuestUpdate4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CancelGuestUpdate4XXResponse

...
function Initialize-CancelGuestUpdate4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CancelGuestUpdate4XXResponse' | Write-Debug
...
Convert from JSON to CancelGuestUpdate4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToCancelGuestUpdate4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CancelGuestUpdate4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CancelGuestUpdate4XXResponse

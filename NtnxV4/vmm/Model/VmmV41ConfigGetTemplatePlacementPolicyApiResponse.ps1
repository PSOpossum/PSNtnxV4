...
function Initialize-VmmV41ConfigGetTemplatePlacementPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ConfigGetTemplatePlacementPolicyApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ConfigGetTemplatePlacementPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ConfigGetTemplatePlacementPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ConfigGetTemplatePlacementPolicyApiResponse

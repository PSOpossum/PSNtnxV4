...
function Initialize-VmmV41ConfigGetTemplatePlacementPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ConfigGetTemplatePlacementPolicyApiResponse' | Write-Debug
...
Convert from JSON to VmmV41ConfigGetTemplatePlacementPolicyApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41ConfigGetTemplatePlacementPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ConfigGetTemplatePlacementPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ConfigGetTemplatePlacementPolicyApiResponse

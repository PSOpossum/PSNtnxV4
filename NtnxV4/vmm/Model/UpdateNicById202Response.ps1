...
function Initialize-UpdateNicById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => UpdateNicById202Response' | Write-Debug
...
function ConvertFrom-JsonToUpdateNicById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => UpdateNicById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateNicById202Response

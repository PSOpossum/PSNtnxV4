...
function Initialize-UpdateNicById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4UpdateNicById202Response' | Write-Debug
...
Convert from JSON to UpdateNicById202Response<PSCustomObject>
...
function ConvertFrom-JsonToUpdateNicById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4UpdateNicById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateNicById202Response

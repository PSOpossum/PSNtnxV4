...
function Initialize-VmmV41AhvPoliciesVmReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvPoliciesVmReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvPoliciesVmReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvPoliciesVmReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvPoliciesVmReference
        $AllProperties = ("extId")

...
function Initialize-GetVmStatsById200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetVmStatsById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetVmStatsById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetVmStatsById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetVmStatsById200Response

...
function Initialize-RebootVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => RebootVm202Response' | Write-Debug
...
function ConvertFrom-JsonToRebootVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => RebootVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RebootVm202Response

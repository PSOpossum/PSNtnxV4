...
function Initialize-VmmV41ImagesConfigDeletePlacementPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ImagesConfigDeletePlacementPolicyApiResponse' | Write-Debug
...
Convert from JSON to VmmV41ImagesConfigDeletePlacementPolicyApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41ImagesConfigDeletePlacementPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ImagesConfigDeletePlacementPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ImagesConfigDeletePlacementPolicyApiResponse

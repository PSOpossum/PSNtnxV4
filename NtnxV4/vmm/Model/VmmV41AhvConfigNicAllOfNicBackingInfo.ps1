...
function Initialize-VmmV41AhvConfigNicAllOfNicBackingInfo {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigNicAllOfNicBackingInfo' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigNicAllOfNicBackingInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigNicAllOfNicBackingInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigNicAllOfNicBackingInfo

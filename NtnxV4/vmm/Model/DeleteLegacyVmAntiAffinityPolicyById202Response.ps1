...
function Initialize-DeleteLegacyVmAntiAffinityPolicyById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeleteLegacyVmAntiAffinityPolicyById202Response' | Write-Debug
...
function ConvertFrom-JsonToDeleteLegacyVmAntiAffinityPolicyById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeleteLegacyVmAntiAffinityPolicyById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteLegacyVmAntiAffinityPolicyById202Response

...
function Initialize-VmmV41AhvConfigNetworkFunctionChainReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigNetworkFunctionChainReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigNetworkFunctionChainReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigNetworkFunctionChainReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigNetworkFunctionChainReference
        $AllProperties = ("extId")

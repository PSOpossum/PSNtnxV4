...
function Initialize-VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ImagesConfigUpdateRateLimitPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse

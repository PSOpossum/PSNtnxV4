...
function Initialize-VmmV41AhvConfigGuestCustomizationParams {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigGuestCustomizationParams' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigGuestCustomizationParams {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigGuestCustomizationParams' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigGuestCustomizationParams

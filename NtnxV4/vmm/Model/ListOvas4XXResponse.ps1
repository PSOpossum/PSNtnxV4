...
function Initialize-ListOvas4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListOvas4XXResponse' | Write-Debug
...
Convert from JSON to ListOvas4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToListOvas4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListOvas4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListOvas4XXResponse

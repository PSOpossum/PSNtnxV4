...
function Initialize-UninstallVmGuestTools202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => UninstallVmGuestTools202Response' | Write-Debug
...
function ConvertFrom-JsonToUninstallVmGuestTools202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => UninstallVmGuestTools202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UninstallVmGuestTools202Response

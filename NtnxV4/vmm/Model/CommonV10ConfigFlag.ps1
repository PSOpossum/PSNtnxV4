...
function Initialize-CommonV10ConfigFlag {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CommonV10ConfigFlag' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigFlag {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CommonV10ConfigFlag' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

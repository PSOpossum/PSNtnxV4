...
function Initialize-VmmV41AhvConfigCategoryReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigCategoryReference' | Write-Debug
...
Convert from JSON to VmmV41AhvConfigCategoryReference<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41AhvConfigCategoryReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigCategoryReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigCategoryReference
        $AllProperties = ("extId")

...
function Initialize-DeleteVmHostAffinityPolicyById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeleteVmHostAffinityPolicyById202Response' | Write-Debug
...
function ConvertFrom-JsonToDeleteVmHostAffinityPolicyById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeleteVmHostAffinityPolicyById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteVmHostAffinityPolicyById202Response

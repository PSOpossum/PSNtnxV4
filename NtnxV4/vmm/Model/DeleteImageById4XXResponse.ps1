...
function Initialize-DeleteImageById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeleteImageById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeleteImageById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeleteImageById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteImageById4XXResponse

...
function Initialize-GetImageById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetImageById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetImageById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetImageById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetImageById4XXResponse

...
function Initialize-ShutdownEsxiGuestVm202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ShutdownEsxiGuestVm202Response' | Write-Debug
...
Convert from JSON to ShutdownEsxiGuestVm202Response<PSCustomObject>
...
function ConvertFrom-JsonToShutdownEsxiGuestVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ShutdownEsxiGuestVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ShutdownEsxiGuestVm202Response

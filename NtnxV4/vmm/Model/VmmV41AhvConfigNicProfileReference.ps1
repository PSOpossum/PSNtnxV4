...
function Initialize-VmmV41AhvConfigNicProfileReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigNicProfileReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigNicProfileReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigNicProfileReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigNicProfileReference
        $AllProperties = ("extId")

...
function Initialize-GetOvaById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetOvaById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetOvaById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetOvaById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetOvaById4XXResponse

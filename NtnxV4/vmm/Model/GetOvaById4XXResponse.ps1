...
function Initialize-GetOvaById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetOvaById4XXResponse' | Write-Debug
...
Convert from JSON to GetOvaById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToGetOvaById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetOvaById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetOvaById4XXResponse

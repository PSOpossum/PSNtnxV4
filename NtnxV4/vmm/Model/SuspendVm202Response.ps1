...
function Initialize-SuspendVm202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4SuspendVm202Response' | Write-Debug
...
Convert from JSON to SuspendVm202Response<PSCustomObject>
...
function ConvertFrom-JsonToSuspendVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4SuspendVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4SuspendVm202Response

...
function Initialize-GetFileByOvaId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetFileByOvaId4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetFileByOvaId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetFileByOvaId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetFileByOvaId4XXResponse

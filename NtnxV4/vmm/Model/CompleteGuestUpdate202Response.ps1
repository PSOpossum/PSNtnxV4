...
function Initialize-CompleteGuestUpdate202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => CompleteGuestUpdate202Response' | Write-Debug
...
function ConvertFrom-JsonToCompleteGuestUpdate202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CompleteGuestUpdate202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CompleteGuestUpdate202Response

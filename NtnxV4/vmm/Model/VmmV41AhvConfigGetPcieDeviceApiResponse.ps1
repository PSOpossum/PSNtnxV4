...
function Initialize-VmmV41AhvConfigGetPcieDeviceApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigGetPcieDeviceApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigGetPcieDeviceApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigGetPcieDeviceApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigGetPcieDeviceApiResponse

...
function Initialize-VmmV41ContentGetTemplateApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ContentGetTemplateApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ContentGetTemplateApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ContentGetTemplateApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ContentGetTemplateApiResponse

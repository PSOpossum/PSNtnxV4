...
function Initialize-DeployOva202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeployOva202Response' | Write-Debug
...
Convert from JSON to DeployOva202Response<PSCustomObject>
...
function ConvertFrom-JsonToDeployOva202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeployOva202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeployOva202Response

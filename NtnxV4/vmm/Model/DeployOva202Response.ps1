...
function Initialize-DeployOva202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeployOva202Response' | Write-Debug
...
function ConvertFrom-JsonToDeployOva202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeployOva202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeployOva202Response

...
function Initialize-ListGpusByVmId200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListGpusByVmId200Response' | Write-Debug
...
function ConvertFrom-JsonToListGpusByVmId200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListGpusByVmId200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListGpusByVmId200Response

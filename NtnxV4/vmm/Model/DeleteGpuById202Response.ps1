...
function Initialize-DeleteGpuById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeleteGpuById202Response' | Write-Debug
...
function ConvertFrom-JsonToDeleteGpuById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeleteGpuById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteGpuById202Response

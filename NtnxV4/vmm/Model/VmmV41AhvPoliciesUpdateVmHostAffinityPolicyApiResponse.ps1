...
function Initialize-VmmV41AhvPoliciesUpdateVmHostAffinityPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesUpdateVmHostAffinityPolicyApiResponse' | Write-Debug
...
Convert from JSON to VmmV41AhvPoliciesUpdateVmHostAffinityPolicyApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41AhvPoliciesUpdateVmHostAffinityPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesUpdateVmHostAffinityPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvPoliciesUpdateVmHostAffinityPolicyApiResponse

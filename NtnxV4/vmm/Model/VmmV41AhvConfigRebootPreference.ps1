...
function Initialize-VmmV41AhvConfigRebootPreference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigRebootPreference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigRebootPreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigRebootPreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigRebootPreference

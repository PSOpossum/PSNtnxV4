...
function Initialize-VmmV41EsxiConfigNutanixRebootPreference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigNutanixRebootPreference' | Write-Debug
...
Convert from JSON to VmmV41EsxiConfigNutanixRebootPreference<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41EsxiConfigNutanixRebootPreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigNutanixRebootPreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41EsxiConfigNutanixRebootPreference

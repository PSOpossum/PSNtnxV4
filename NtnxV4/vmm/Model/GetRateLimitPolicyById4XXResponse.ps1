...
function Initialize-GetRateLimitPolicyById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetRateLimitPolicyById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetRateLimitPolicyById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetRateLimitPolicyById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetRateLimitPolicyById4XXResponse

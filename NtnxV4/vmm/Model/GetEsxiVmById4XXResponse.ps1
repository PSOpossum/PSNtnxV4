...
function Initialize-GetEsxiVmById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetEsxiVmById4XXResponse' | Write-Debug
...
Convert from JSON to GetEsxiVmById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToGetEsxiVmById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetEsxiVmById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetEsxiVmById4XXResponse

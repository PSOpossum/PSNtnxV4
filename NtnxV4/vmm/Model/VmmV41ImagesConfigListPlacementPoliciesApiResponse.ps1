...
function Initialize-VmmV41ImagesConfigListPlacementPoliciesApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ImagesConfigListPlacementPoliciesApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ImagesConfigListPlacementPoliciesApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ImagesConfigListPlacementPoliciesApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ImagesConfigListPlacementPoliciesApiResponse

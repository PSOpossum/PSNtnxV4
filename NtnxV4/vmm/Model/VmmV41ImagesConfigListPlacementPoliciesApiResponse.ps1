...
function Initialize-VmmV41ImagesConfigListPlacementPoliciesApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ImagesConfigListPlacementPoliciesApiResponse' | Write-Debug
...
Convert from JSON to VmmV41ImagesConfigListPlacementPoliciesApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41ImagesConfigListPlacementPoliciesApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ImagesConfigListPlacementPoliciesApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ImagesConfigListPlacementPoliciesApiResponse

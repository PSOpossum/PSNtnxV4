...
function Initialize-VmmV41AhvConfigDeleteDiskApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigDeleteDiskApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigDeleteDiskApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigDeleteDiskApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigDeleteDiskApiResponse

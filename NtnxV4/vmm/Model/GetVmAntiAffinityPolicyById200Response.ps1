...
function Initialize-GetVmAntiAffinityPolicyById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetVmAntiAffinityPolicyById200Response' | Write-Debug
...
Convert from JSON to GetVmAntiAffinityPolicyById200Response<PSCustomObject>
...
function ConvertFrom-JsonToGetVmAntiAffinityPolicyById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetVmAntiAffinityPolicyById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetVmAntiAffinityPolicyById200Response

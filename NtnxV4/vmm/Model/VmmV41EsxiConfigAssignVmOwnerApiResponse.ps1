...
function Initialize-VmmV41EsxiConfigAssignVmOwnerApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41EsxiConfigAssignVmOwnerApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41EsxiConfigAssignVmOwnerApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41EsxiConfigAssignVmOwnerApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41EsxiConfigAssignVmOwnerApiResponse

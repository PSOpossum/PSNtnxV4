...
function Initialize-DeleteVmById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeleteVmById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeleteVmById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeleteVmById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteVmById4XXResponse

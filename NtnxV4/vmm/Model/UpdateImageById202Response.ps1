...
function Initialize-UpdateImageById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => UpdateImageById202Response' | Write-Debug
...
function ConvertFrom-JsonToUpdateImageById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => UpdateImageById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateImageById202Response

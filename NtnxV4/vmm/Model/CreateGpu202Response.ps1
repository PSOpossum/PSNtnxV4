...
function Initialize-CreateGpu202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => CreateGpu202Response' | Write-Debug
...
function ConvertFrom-JsonToCreateGpu202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CreateGpu202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateGpu202Response

...
function Initialize-VmmV41EsxiConfigVmDiskContainerReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41EsxiConfigVmDiskContainerReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41EsxiConfigVmDiskContainerReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41EsxiConfigVmDiskContainerReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41EsxiConfigVmDiskContainerReference
        $AllProperties = ("extId")

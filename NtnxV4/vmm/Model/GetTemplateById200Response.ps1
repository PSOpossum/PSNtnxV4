...
function Initialize-GetTemplateById200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetTemplateById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetTemplateById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetTemplateById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetTemplateById200Response

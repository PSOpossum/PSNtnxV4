...
function Initialize-VmmV41AhvPoliciesClusterReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvPoliciesClusterReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvPoliciesClusterReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvPoliciesClusterReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvPoliciesClusterReference
        $AllProperties = ("extId")

...
function Initialize-DeleteVmRecoveryPointByExtId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeleteVmRecoveryPointByExtId4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeleteVmRecoveryPointByExtId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeleteVmRecoveryPointByExtId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteVmRecoveryPointByExtId4XXResponse

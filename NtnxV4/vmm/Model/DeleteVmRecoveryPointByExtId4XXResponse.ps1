...
function Initialize-DeleteVmRecoveryPointByExtId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteVmRecoveryPointByExtId4XXResponse' | Write-Debug
...
Convert from JSON to DeleteVmRecoveryPointByExtId4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToDeleteVmRecoveryPointByExtId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteVmRecoveryPointByExtId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteVmRecoveryPointByExtId4XXResponse

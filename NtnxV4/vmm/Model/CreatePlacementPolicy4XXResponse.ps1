...
function Initialize-CreatePlacementPolicy4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CreatePlacementPolicy4XXResponse' | Write-Debug
...
Convert from JSON to CreatePlacementPolicy4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToCreatePlacementPolicy4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CreatePlacementPolicy4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CreatePlacementPolicy4XXResponse

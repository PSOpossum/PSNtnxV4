...
function Initialize-MigrateNicById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4MigrateNicById202Response' | Write-Debug
...
Convert from JSON to MigrateNicById202Response<PSCustomObject>
...
function ConvertFrom-JsonToMigrateNicById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4MigrateNicById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4MigrateNicById202Response

...
function Initialize-GetEsxiDiskStatsById200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetEsxiDiskStatsById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetEsxiDiskStatsById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetEsxiDiskStatsById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetEsxiDiskStatsById200Response

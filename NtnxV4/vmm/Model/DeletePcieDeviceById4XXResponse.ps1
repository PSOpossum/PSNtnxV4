...
function Initialize-DeletePcieDeviceById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeletePcieDeviceById4XXResponse' | Write-Debug
...
Convert from JSON to DeletePcieDeviceById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToDeletePcieDeviceById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeletePcieDeviceById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeletePcieDeviceById4XXResponse

...
function Initialize-VmmV41AhvConfigClusterReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigClusterReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigClusterReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigClusterReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigClusterReference
        $AllProperties = ("extId")

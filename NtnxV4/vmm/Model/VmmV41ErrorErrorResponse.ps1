...
function Initialize-VmmV41ErrorErrorResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ErrorErrorResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ErrorErrorResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ErrorErrorResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ErrorErrorResponse
        $AllProperties = ("error")

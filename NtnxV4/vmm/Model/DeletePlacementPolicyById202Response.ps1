...
function Initialize-DeletePlacementPolicyById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeletePlacementPolicyById202Response' | Write-Debug
...
function ConvertFrom-JsonToDeletePlacementPolicyById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeletePlacementPolicyById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeletePlacementPolicyById202Response

...
function Initialize-ListTemplates200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListTemplates200Response' | Write-Debug
...
function ConvertFrom-JsonToListTemplates200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListTemplates200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListTemplates200Response

...
function Initialize-AssignVmOwner202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => AssignVmOwner202Response' | Write-Debug
...
function ConvertFrom-JsonToAssignVmOwner202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => AssignVmOwner202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssignVmOwner202Response

...
function Initialize-RemoveNode202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => RemoveNode202Response' | Write-Debug
...
function ConvertFrom-JsonToRemoveNode202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => RemoveNode202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RemoveNode202Response

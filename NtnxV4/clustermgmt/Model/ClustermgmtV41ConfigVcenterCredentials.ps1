...
function Initialize-ClustermgmtV41ConfigVcenterCredentials {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigVcenterCredentials' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigVcenterCredentials {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigVcenterCredentials' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigVcenterCredentials

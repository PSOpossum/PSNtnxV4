...
function Initialize-ListDataStoresByClusterId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ListDataStoresByClusterId4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListDataStoresByClusterId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ListDataStoresByClusterId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListDataStoresByClusterId4XXResponse

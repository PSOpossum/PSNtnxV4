...
function Initialize-ClustermgmtV41OperationsExitHostMaintenanceApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ClustermgmtV41OperationsExitHostMaintenanceApiResponse' | Write-Debug
...
Convert from JSON to ClustermgmtV41OperationsExitHostMaintenanceApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToClustermgmtV41OperationsExitHostMaintenanceApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ClustermgmtV41OperationsExitHostMaintenanceApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ClustermgmtV41OperationsExitHostMaintenanceApiResponse

...
function Initialize-ClustermgmtV41ConfigDeleteDiskApiResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigDeleteDiskApiResponse' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigDeleteDiskApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigDeleteDiskApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigDeleteDiskApiResponse

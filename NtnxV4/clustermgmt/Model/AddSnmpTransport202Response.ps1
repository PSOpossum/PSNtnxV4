...
function Initialize-AddSnmpTransport202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4AddSnmpTransport202Response' | Write-Debug
...
Convert from JSON to AddSnmpTransport202Response<PSCustomObject>
...
function ConvertFrom-JsonToAddSnmpTransport202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4AddSnmpTransport202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4AddSnmpTransport202Response

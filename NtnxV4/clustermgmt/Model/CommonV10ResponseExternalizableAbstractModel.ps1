...
function Initialize-CommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CommonV10ResponseExternalizableAbstractModel' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CommonV10ResponseExternalizableAbstractModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-EnterHostMaintenance202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => EnterHostMaintenance202Response' | Write-Debug
...
function ConvertFrom-JsonToEnterHostMaintenance202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => EnterHostMaintenance202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnterHostMaintenance202Response

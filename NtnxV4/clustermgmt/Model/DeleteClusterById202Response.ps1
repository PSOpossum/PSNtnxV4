...
function Initialize-DeleteClusterById202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => DeleteClusterById202Response' | Write-Debug
...
function ConvertFrom-JsonToDeleteClusterById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => DeleteClusterById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteClusterById202Response

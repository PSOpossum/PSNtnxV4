...
function Initialize-ClustermgmtV41ConfigTaskResponse {
    ...
    Param (
        ...
        [ValidateSet("UNCONFIGURED_NODES", "NETWORKING_DETAILS", "HYPERVISOR_UPLOAD_INFO", "VALIDATE_BUNDLE_INFO", "NON_COMPATIBLE_CLUSTERS", "UNKNOWN", "REDACTED")]
        [PSCustomObject]
        ${TaskResponseType},
...
Convert from JSON to ClustermgmtV41ConfigTaskResponse<PSCustomObject>
...
function ConvertFrom-JsonToClustermgmtV41ConfigTaskResponse {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "taskResponseType"))) { #optional property not found
            $TaskResponseType = $null
        } else {
            $TaskResponseType = $JsonParameters.PSobject.Properties["taskResponseType"].value
        }

...
function Initialize-UpdateDiskLEDState4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => UpdateDiskLEDState4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToUpdateDiskLEDState4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => UpdateDiskLEDState4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateDiskLEDState4XXResponse

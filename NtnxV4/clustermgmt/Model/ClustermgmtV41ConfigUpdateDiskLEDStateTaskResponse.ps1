...
function Initialize-ClustermgmtV41ConfigUpdateDiskLEDStateTaskResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigUpdateDiskLEDStateTaskResponse' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigUpdateDiskLEDStateTaskResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigUpdateDiskLEDStateTaskResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigUpdateDiskLEDStateTaskResponse

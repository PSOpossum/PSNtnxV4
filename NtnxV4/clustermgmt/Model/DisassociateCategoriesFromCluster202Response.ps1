...
function Initialize-DisassociateCategoriesFromCluster202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => DisassociateCategoriesFromCluster202Response' | Write-Debug
...
function ConvertFrom-JsonToDisassociateCategoriesFromCluster202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => DisassociateCategoriesFromCluster202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DisassociateCategoriesFromCluster202Response

...
function Initialize-GetHostStats4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetHostStats4XXResponse' | Write-Debug
...
Convert from JSON to GetHostStats4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToGetHostStats4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4GetHostStats4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetHostStats4XXResponse

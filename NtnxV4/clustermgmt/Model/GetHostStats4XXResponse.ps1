...
function Initialize-GetHostStats4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => GetHostStats4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetHostStats4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => GetHostStats4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetHostStats4XXResponse

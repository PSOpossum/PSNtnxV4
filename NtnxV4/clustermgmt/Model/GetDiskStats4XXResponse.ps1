...
function Initialize-GetDiskStats4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => GetDiskStats4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetDiskStats4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => GetDiskStats4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetDiskStats4XXResponse

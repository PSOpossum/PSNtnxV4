...
function Initialize-UpdateSSLCertificate202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => UpdateSSLCertificate202Response' | Write-Debug
...
function ConvertFrom-JsonToUpdateSSLCertificate202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => UpdateSSLCertificate202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateSSLCertificate202Response

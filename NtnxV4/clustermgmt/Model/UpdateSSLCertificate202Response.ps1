...
function Initialize-UpdateSSLCertificate202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4UpdateSSLCertificate202Response' | Write-Debug
...
Convert from JSON to UpdateSSLCertificate202Response<PSCustomObject>
...
function ConvertFrom-JsonToUpdateSSLCertificate202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4UpdateSSLCertificate202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateSSLCertificate202Response

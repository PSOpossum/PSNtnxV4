...
function Initialize-UpdateBmcInfo202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => UpdateBmcInfo202Response' | Write-Debug
...
function ConvertFrom-JsonToUpdateBmcInfo202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => UpdateBmcInfo202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateBmcInfo202Response

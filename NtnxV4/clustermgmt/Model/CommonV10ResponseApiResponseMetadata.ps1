...
function Initialize-CommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CommonV10ResponseApiResponseMetadata' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CommonV10ResponseApiResponseMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

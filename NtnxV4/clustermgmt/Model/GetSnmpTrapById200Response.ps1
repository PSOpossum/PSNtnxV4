...
function Initialize-GetSnmpTrapById200Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => GetSnmpTrapById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetSnmpTrapById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => GetSnmpTrapById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetSnmpTrapById200Response

...
function Initialize-ChangeSystemUserPasswordById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ChangeSystemUserPasswordById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToChangeSystemUserPasswordById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ChangeSystemUserPasswordById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ChangeSystemUserPasswordById4XXResponse

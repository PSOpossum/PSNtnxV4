...
function Initialize-ChangeSystemUserPasswordById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.clustermgmt => NtnxV4ChangeSystemUserPasswordById4XXResponse' | Write-Debug
...
Convert from JSON to ChangeSystemUserPasswordById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToChangeSystemUserPasswordById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.clustermgmt => NtnxV4ChangeSystemUserPasswordById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ChangeSystemUserPasswordById4XXResponse

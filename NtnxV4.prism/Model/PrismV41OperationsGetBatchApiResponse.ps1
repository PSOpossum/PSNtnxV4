...
function Initialize-NtnxV4PrismV41OperationsGetBatchApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41OperationsGetBatchApiResponse' | Write-Debug
...
Convert from JSON to PrismV41OperationsGetBatchApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToPrismV41OperationsGetBatchApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41OperationsGetBatchApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41OperationsGetBatchApiResponse

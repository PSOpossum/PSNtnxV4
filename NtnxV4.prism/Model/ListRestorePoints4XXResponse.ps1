...
function Initialize-NtnxV4ListRestorePoints4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4ListRestorePoints4XXResponse' | Write-Debug
...
Convert from JSON to ListRestorePoints4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListRestorePoints4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4ListRestorePoints4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListRestorePoints4XXResponse

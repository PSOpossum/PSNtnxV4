...
function Initialize-NtnxV4Unregister202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4Unregister202Response' | Write-Debug
...
Convert from JSON to Unregister202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToUnregister202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4Unregister202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4Unregister202Response

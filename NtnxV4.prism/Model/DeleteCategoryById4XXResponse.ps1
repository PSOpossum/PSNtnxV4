...
function Initialize-DeleteCategoryById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4DeleteCategoryById4XXResponse' | Write-Debug
...
Convert from JSON to DeleteCategoryById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToDeleteCategoryById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4DeleteCategoryById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteCategoryById4XXResponse

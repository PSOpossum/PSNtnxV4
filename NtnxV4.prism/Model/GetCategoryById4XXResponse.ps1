...
function Initialize-NtnxV4GetCategoryById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4GetCategoryById4XXResponse' | Write-Debug
...
Convert from JSON to GetCategoryById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetCategoryById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4GetCategoryById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetCategoryById4XXResponse

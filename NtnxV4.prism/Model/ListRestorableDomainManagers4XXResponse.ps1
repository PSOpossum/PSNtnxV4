...
function Initialize-NtnxV4ListRestorableDomainManagers4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4ListRestorableDomainManagers4XXResponse' | Write-Debug
...
Convert from JSON to ListRestorableDomainManagers4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListRestorableDomainManagers4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4ListRestorableDomainManagers4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListRestorableDomainManagers4XXResponse

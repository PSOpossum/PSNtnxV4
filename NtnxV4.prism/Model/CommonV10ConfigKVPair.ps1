...
function Initialize-NtnxV4CommonV10ConfigKVPair {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4CommonV10ConfigKVPair' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigKVPair {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4CommonV10ConfigKVPair' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

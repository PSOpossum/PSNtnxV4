...
function Initialize-NtnxV4CancelTask200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4CancelTask200Response' | Write-Debug
...
Convert from JSON to CancelTask200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCancelTask200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4CancelTask200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CancelTask200Response

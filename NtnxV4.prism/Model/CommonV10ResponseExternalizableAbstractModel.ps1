...
function Initialize-NtnxV4CommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4CommonV10ResponseExternalizableAbstractModel' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ResponseExternalizableAbstractModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4CommonV10ResponseExternalizableAbstractModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

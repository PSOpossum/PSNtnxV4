...
function Initialize-PrismV41ErrorSchemaValidationError {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ErrorSchemaValidationError' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ErrorSchemaValidationError {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ErrorSchemaValidationError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41ErrorSchemaValidationError

...
function Initialize-PrismV41ManagementGetProductApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ManagementGetProductApiResponse' | Write-Debug
...
Convert from JSON to PrismV41ManagementGetProductApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToPrismV41ManagementGetProductApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ManagementGetProductApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41ManagementGetProductApiResponse

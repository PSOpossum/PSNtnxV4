...
function Initialize-PrismV41ConfigGetTaskApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ConfigGetTaskApiResponse' | Write-Debug
...
Convert from JSON to PrismV41ConfigGetTaskApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToPrismV41ConfigGetTaskApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ConfigGetTaskApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41ConfigGetTaskApiResponse

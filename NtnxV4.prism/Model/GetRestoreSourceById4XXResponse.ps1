...
function Initialize-GetRestoreSourceById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4GetRestoreSourceById4XXResponse' | Write-Debug
...
Convert from JSON to GetRestoreSourceById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToGetRestoreSourceById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4GetRestoreSourceById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetRestoreSourceById4XXResponse

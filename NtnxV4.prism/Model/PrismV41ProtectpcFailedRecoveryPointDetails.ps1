...
function Initialize-PrismV41ProtectpcFailedRecoveryPointDetails {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ProtectpcFailedRecoveryPointDetails' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ProtectpcFailedRecoveryPointDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4PrismV41ProtectpcFailedRecoveryPointDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PrismV41ProtectpcFailedRecoveryPointDetails

...
This attribute contains a list of entities that have been assigned the given category.<br> These entities are grouped by entity types (like VM or HOST).<br> Each associated object contains the total entities belonging to the given entity type, and category extId. 
...
Convert from JSON to PrismV41ConfigCategoryAssociationSummaryOld<PSCustomObject>

...
function Initialize-NtnxV4GetTaskById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4GetTaskById4XXResponse' | Write-Debug
...
Convert from JSON to GetTaskById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetTaskById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4GetTaskById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetTaskById4XXResponse

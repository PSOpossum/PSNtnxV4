...
function Initialize-NtnxV4CommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.prism => NtnxV4CommonV10ResponseApiResponseMetadata' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.prism => NtnxV4CommonV10ResponseApiResponseMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

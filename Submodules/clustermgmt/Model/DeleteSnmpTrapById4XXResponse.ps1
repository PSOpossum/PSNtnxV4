...
function Initialize-DeleteSnmpTrapById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => DeleteSnmpTrapById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeleteSnmpTrapById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => DeleteSnmpTrapById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteSnmpTrapById4XXResponse

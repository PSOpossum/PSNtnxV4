...
function Initialize-CommonV10ConfigIPAddressOrFQDN {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CommonV10ConfigIPAddressOrFQDN' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIPAddressOrFQDN {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CommonV10ConfigIPAddressOrFQDN' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

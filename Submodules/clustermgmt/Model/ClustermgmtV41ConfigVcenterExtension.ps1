...
function Initialize-ClustermgmtV41ConfigVcenterExtension {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigVcenterExtension' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigVcenterExtension {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigVcenterExtension' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigVcenterExtension

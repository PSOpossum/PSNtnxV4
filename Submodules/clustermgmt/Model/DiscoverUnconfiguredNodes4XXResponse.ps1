...
function Initialize-DiscoverUnconfiguredNodes4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => DiscoverUnconfiguredNodes4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDiscoverUnconfiguredNodes4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => DiscoverUnconfiguredNodes4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DiscoverUnconfiguredNodes4XXResponse

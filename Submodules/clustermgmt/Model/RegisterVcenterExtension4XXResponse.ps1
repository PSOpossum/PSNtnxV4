...
function Initialize-RegisterVcenterExtension4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => RegisterVcenterExtension4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToRegisterVcenterExtension4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => RegisterVcenterExtension4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RegisterVcenterExtension4XXResponse

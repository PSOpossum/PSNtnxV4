...
function Initialize-ListPcieDevices200Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ListPcieDevices200Response' | Write-Debug
...
function ConvertFrom-JsonToListPcieDevices200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ListPcieDevices200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListPcieDevices200Response

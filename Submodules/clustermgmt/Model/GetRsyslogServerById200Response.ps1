...
function Initialize-GetRsyslogServerById200Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => GetRsyslogServerById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetRsyslogServerById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => GetRsyslogServerById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetRsyslogServerById200Response

...
function Initialize-AddDisk4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => AddDisk4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToAddDisk4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => AddDisk4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AddDisk4XXResponse

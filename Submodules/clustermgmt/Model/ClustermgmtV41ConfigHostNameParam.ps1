...
function Initialize-ClustermgmtV41ConfigHostNameParam {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigHostNameParam' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigHostNameParam {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigHostNameParam' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigHostNameParam
        $AllProperties = ("name")

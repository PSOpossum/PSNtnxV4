...
function Initialize-ClustermgmtV41ConfigBuildInfo {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigBuildInfo' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigBuildInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigBuildInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

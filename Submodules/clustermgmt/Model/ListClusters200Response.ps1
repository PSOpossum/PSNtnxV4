...
function Initialize-ListClusters200Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ListClusters200Response' | Write-Debug
...
function ConvertFrom-JsonToListClusters200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ListClusters200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListClusters200Response

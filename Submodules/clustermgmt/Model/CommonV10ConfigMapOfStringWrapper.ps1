...
function Initialize-CommonV10ConfigMapOfStringWrapper {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CommonV10ConfigMapOfStringWrapper' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigMapOfStringWrapper {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CommonV10ConfigMapOfStringWrapper' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-ListHostsByClusterId200Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ListHostsByClusterId200Response' | Write-Debug
...
function ConvertFrom-JsonToListHostsByClusterId200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ListHostsByClusterId200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListHostsByClusterId200Response

...
function Initialize-ClustermgmtV41ConfigFetchTaskApiResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigFetchTaskApiResponse' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigFetchTaskApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigFetchTaskApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigFetchTaskApiResponse

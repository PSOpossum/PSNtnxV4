...
function Initialize-DeleteDiskById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => DeleteDiskById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeleteDiskById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => DeleteDiskById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteDiskById4XXResponse

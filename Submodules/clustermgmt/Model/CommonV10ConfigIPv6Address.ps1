...
function Initialize-CommonV10ConfigIPv6Address {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CommonV10ConfigIPv6Address' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIPv6Address {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CommonV10ConfigIPv6Address' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

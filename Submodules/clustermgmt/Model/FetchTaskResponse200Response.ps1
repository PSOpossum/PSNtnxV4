...
function Initialize-FetchTaskResponse200Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => FetchTaskResponse200Response' | Write-Debug
...
function ConvertFrom-JsonToFetchTaskResponse200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => FetchTaskResponse200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FetchTaskResponse200Response

...
function Initialize-ClustermgmtV41ConfigGetRsyslogServerApiResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigGetRsyslogServerApiResponse' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigGetRsyslogServerApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigGetRsyslogServerApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigGetRsyslogServerApiResponse

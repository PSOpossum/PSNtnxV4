...
function Initialize-ApplyClusterProfile202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ApplyClusterProfile202Response' | Write-Debug
...
function ConvertFrom-JsonToApplyClusterProfile202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ApplyClusterProfile202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ApplyClusterProfile202Response

...
function Initialize-CheckHypervisorRequirements202Response {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CheckHypervisorRequirements202Response' | Write-Debug
...
function ConvertFrom-JsonToCheckHypervisorRequirements202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CheckHypervisorRequirements202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CheckHypervisorRequirements202Response

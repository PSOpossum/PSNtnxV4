...
function Initialize-ClustermgmtV41ConfigDigitalCertificateMapReference {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigDigitalCertificateMapReference' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigDigitalCertificateMapReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigDigitalCertificateMapReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigDigitalCertificateMapReference

...
function Initialize-ClustermgmtV41ConfigChangeSystemUserPasswordApiResponse {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => ClustermgmtV41ConfigChangeSystemUserPasswordApiResponse' | Write-Debug
...
function ConvertFrom-JsonToClustermgmtV41ConfigChangeSystemUserPasswordApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => ClustermgmtV41ConfigChangeSystemUserPasswordApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ClustermgmtV41ConfigChangeSystemUserPasswordApiResponse

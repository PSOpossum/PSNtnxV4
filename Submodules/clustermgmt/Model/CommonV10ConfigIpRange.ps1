...
function Initialize-CommonV10ConfigIpRange {
    ...
    Process {
        'Creating PSCustomObject: clustermgmt => CommonV10ConfigIpRange' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIpRange {
    ...
    Process {
        'Converting JSON to PSCustomObject: clustermgmt => CommonV10ConfigIpRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

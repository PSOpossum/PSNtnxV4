...
function Initialize-ListRestorePoints4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => ListRestorePoints4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListRestorePoints4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => ListRestorePoints4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListRestorePoints4XXResponse

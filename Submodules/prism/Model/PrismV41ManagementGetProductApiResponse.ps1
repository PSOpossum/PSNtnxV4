...
function Initialize-PrismV41ManagementGetProductApiResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41ManagementGetProductApiResponse' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ManagementGetProductApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41ManagementGetProductApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41ManagementGetProductApiResponse

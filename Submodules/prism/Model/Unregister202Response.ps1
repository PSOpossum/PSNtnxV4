...
function Initialize-Unregister202Response {
    ...
    Process {
        'Creating PSCustomObject: prism => Unregister202Response' | Write-Debug
...
function ConvertFrom-JsonToUnregister202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => Unregister202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Unregister202Response

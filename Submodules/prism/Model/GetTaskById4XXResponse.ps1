...
function Initialize-GetTaskById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => GetTaskById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetTaskById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => GetTaskById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetTaskById4XXResponse

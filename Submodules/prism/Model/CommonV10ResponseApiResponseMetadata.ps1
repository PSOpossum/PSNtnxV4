...
function Initialize-CommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Creating PSCustomObject: prism => CommonV10ResponseApiResponseMetadata' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ResponseApiResponseMetadata {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => CommonV10ResponseApiResponseMetadata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

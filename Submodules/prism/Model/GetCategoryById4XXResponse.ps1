...
function Initialize-GetCategoryById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => GetCategoryById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToGetCategoryById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => GetCategoryById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetCategoryById4XXResponse

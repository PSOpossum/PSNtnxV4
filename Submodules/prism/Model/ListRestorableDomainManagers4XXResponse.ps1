...
function Initialize-ListRestorableDomainManagers4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => ListRestorableDomainManagers4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListRestorableDomainManagers4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => ListRestorableDomainManagers4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListRestorableDomainManagers4XXResponse

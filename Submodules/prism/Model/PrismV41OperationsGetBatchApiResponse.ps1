...
function Initialize-PrismV41OperationsGetBatchApiResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41OperationsGetBatchApiResponse' | Write-Debug
...
function ConvertFrom-JsonToPrismV41OperationsGetBatchApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41OperationsGetBatchApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41OperationsGetBatchApiResponse

...
function Initialize-PrismV41ConfigAssociationSummary {
    ...
    Process {
        'Creating PSCustomObject: prism => PrismV41ConfigAssociationSummary' | Write-Debug
...
function ConvertFrom-JsonToPrismV41ConfigAssociationSummary {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => PrismV41ConfigAssociationSummary' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PrismV41ConfigAssociationSummary

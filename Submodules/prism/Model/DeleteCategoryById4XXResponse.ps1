...
function Initialize-DeleteCategoryById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: prism => DeleteCategoryById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeleteCategoryById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: prism => DeleteCategoryById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteCategoryById4XXResponse

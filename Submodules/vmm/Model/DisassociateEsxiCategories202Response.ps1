...
function Initialize-DisassociateEsxiCategories202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => DisassociateEsxiCategories202Response' | Write-Debug
...
function ConvertFrom-JsonToDisassociateEsxiCategories202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DisassociateEsxiCategories202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DisassociateEsxiCategories202Response

...
function Initialize-MigrateVmToHost202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => MigrateVmToHost202Response' | Write-Debug
...
function ConvertFrom-JsonToMigrateVmToHost202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => MigrateVmToHost202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MigrateVmToHost202Response

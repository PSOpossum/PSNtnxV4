...
function Initialize-VmmV41ImagesConfigDeletePlacementPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ImagesConfigDeletePlacementPolicyApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ImagesConfigDeletePlacementPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ImagesConfigDeletePlacementPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ImagesConfigDeletePlacementPolicyApiResponse

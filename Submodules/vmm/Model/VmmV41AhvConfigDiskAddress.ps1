...
function Initialize-VmmV41AhvConfigDiskAddress {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigDiskAddress' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigDiskAddress {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigDiskAddress' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigDiskAddress

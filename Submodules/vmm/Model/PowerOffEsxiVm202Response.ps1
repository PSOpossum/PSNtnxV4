...
function Initialize-PowerOffEsxiVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => PowerOffEsxiVm202Response' | Write-Debug
...
function ConvertFrom-JsonToPowerOffEsxiVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => PowerOffEsxiVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerOffEsxiVm202Response

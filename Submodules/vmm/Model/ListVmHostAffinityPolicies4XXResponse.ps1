...
function Initialize-ListVmHostAffinityPolicies4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListVmHostAffinityPolicies4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListVmHostAffinityPolicies4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListVmHostAffinityPolicies4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListVmHostAffinityPolicies4XXResponse

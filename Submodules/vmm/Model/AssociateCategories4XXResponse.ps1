...
function Initialize-AssociateCategories4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => AssociateCategories4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToAssociateCategories4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => AssociateCategories4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssociateCategories4XXResponse

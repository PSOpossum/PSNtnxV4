...
function Initialize-VmmV41AhvPoliciesCategoryReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvPoliciesCategoryReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvPoliciesCategoryReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvPoliciesCategoryReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvPoliciesCategoryReference
        $AllProperties = ("extId")

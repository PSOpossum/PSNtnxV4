...
function Initialize-VmmV41AhvConfigListSerialPortsApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigListSerialPortsApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigListSerialPortsApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigListSerialPortsApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigListSerialPortsApiResponse

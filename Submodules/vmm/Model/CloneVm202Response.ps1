...
function Initialize-CloneVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => CloneVm202Response' | Write-Debug
...
function ConvertFrom-JsonToCloneVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CloneVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CloneVm202Response

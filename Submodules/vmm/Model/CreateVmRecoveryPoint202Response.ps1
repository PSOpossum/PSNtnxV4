...
function Initialize-CreateVmRecoveryPoint202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => CreateVmRecoveryPoint202Response' | Write-Debug
...
function ConvertFrom-JsonToCreateVmRecoveryPoint202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CreateVmRecoveryPoint202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateVmRecoveryPoint202Response

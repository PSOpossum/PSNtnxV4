...
function Initialize-ListLegacyVmAntiAffinityPolicies200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListLegacyVmAntiAffinityPolicies200Response' | Write-Debug
...
function ConvertFrom-JsonToListLegacyVmAntiAffinityPolicies200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListLegacyVmAntiAffinityPolicies200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListLegacyVmAntiAffinityPolicies200Response

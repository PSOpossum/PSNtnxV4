...
function Initialize-PowerCycleVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => PowerCycleVm202Response' | Write-Debug
...
function ConvertFrom-JsonToPowerCycleVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => PowerCycleVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerCycleVm202Response

...
function Initialize-SuspendVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => SuspendVm202Response' | Write-Debug
...
function ConvertFrom-JsonToSuspendVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => SuspendVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuspendVm202Response

...
function Initialize-VmmV41AhvConfigBootDeviceNic {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigBootDeviceNic' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigBootDeviceNic {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigBootDeviceNic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigBootDeviceNic

...
function Initialize-GetEsxiNicStatsById200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetEsxiNicStatsById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetEsxiNicStatsById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetEsxiNicStatsById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetEsxiNicStatsById200Response

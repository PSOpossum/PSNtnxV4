...
function Initialize-ResumePlacementPolicy4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => ResumePlacementPolicy4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToResumePlacementPolicy4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ResumePlacementPolicy4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ResumePlacementPolicy4XXResponse

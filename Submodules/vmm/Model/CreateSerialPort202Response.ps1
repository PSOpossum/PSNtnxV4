...
function Initialize-CreateSerialPort202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => CreateSerialPort202Response' | Write-Debug
...
function ConvertFrom-JsonToCreateSerialPort202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CreateSerialPort202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateSerialPort202Response

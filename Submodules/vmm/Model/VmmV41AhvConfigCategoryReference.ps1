...
function Initialize-VmmV41AhvConfigCategoryReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigCategoryReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigCategoryReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigCategoryReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigCategoryReference
        $AllProperties = ("extId")

...
function Initialize-GetVmAntiAffinityPolicyById200Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => GetVmAntiAffinityPolicyById200Response' | Write-Debug
...
function ConvertFrom-JsonToGetVmAntiAffinityPolicyById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => GetVmAntiAffinityPolicyById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetVmAntiAffinityPolicyById200Response

...
function Initialize-DeletePcieDeviceById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => DeletePcieDeviceById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToDeletePcieDeviceById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => DeletePcieDeviceById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeletePcieDeviceById4XXResponse

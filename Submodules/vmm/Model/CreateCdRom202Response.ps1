...
function Initialize-CreateCdRom202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => CreateCdRom202Response' | Write-Debug
...
function ConvertFrom-JsonToCreateCdRom202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CreateCdRom202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateCdRom202Response

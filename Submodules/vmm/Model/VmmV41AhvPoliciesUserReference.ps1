...
function Initialize-VmmV41AhvPoliciesUserReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvPoliciesUserReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvPoliciesUserReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvPoliciesUserReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvPoliciesUserReference
        $AllProperties = ("extId")

...
function Initialize-VmmV41ContentInitiateGuestUpdateSpec {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41ContentInitiateGuestUpdateSpec' | Write-Debug
...
function ConvertFrom-JsonToVmmV41ContentInitiateGuestUpdateSpec {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41ContentInitiateGuestUpdateSpec' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41ContentInitiateGuestUpdateSpec

...
function Initialize-AssignIpById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => AssignIpById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToAssignIpById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => AssignIpById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AssignIpById4XXResponse

...
function Initialize-VmmV41EsxiConfigNutanixRebootPreference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41EsxiConfigNutanixRebootPreference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41EsxiConfigNutanixRebootPreference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41EsxiConfigNutanixRebootPreference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41EsxiConfigNutanixRebootPreference

...
function Initialize-PowerOnEsxiVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => PowerOnEsxiVm202Response' | Write-Debug
...
function ConvertFrom-JsonToPowerOnEsxiVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => PowerOnEsxiVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PowerOnEsxiVm202Response

...
function Initialize-UpgradeVmGuestTools202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => UpgradeVmGuestTools202Response' | Write-Debug
...
function ConvertFrom-JsonToUpgradeVmGuestTools202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => UpgradeVmGuestTools202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpgradeVmGuestTools202Response

...
function Initialize-CommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Creating PSCustomObject: vmm => CommonV10ConfigTenantAwareModel' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CommonV10ConfigTenantAwareModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

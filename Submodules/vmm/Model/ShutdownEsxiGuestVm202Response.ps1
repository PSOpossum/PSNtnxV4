...
function Initialize-ShutdownEsxiGuestVm202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => ShutdownEsxiGuestVm202Response' | Write-Debug
...
function ConvertFrom-JsonToShutdownEsxiGuestVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ShutdownEsxiGuestVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ShutdownEsxiGuestVm202Response

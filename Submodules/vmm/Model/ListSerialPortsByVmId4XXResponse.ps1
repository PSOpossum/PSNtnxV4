...
function Initialize-ListSerialPortsByVmId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListSerialPortsByVmId4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListSerialPortsByVmId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListSerialPortsByVmId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListSerialPortsByVmId4XXResponse

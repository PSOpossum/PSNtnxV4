...
function Initialize-CreatePlacementPolicy4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => CreatePlacementPolicy4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToCreatePlacementPolicy4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => CreatePlacementPolicy4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreatePlacementPolicy4XXResponse

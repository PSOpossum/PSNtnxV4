...
function Initialize-VmmV41AhvConfigVmAllOfBootConfig {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigVmAllOfBootConfig' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigVmAllOfBootConfig {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigVmAllOfBootConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigVmAllOfBootConfig

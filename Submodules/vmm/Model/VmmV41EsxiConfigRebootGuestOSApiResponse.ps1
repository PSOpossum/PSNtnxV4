...
function Initialize-VmmV41EsxiConfigRebootGuestOSApiResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41EsxiConfigRebootGuestOSApiResponse' | Write-Debug
...
function ConvertFrom-JsonToVmmV41EsxiConfigRebootGuestOSApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41EsxiConfigRebootGuestOSApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41EsxiConfigRebootGuestOSApiResponse

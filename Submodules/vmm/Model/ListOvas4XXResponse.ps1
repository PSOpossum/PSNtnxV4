...
function Initialize-ListOvas4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: vmm => ListOvas4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToListOvas4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => ListOvas4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListOvas4XXResponse

...
function Initialize-VmmV41AhvPoliciesHostReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvPoliciesHostReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvPoliciesHostReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvPoliciesHostReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvPoliciesHostReference
        $AllProperties = ("extId")

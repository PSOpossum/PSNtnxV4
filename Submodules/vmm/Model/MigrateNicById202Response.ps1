...
function Initialize-MigrateNicById202Response {
    ...
    Process {
        'Creating PSCustomObject: vmm => MigrateNicById202Response' | Write-Debug
...
function ConvertFrom-JsonToMigrateNicById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => MigrateNicById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MigrateNicById202Response

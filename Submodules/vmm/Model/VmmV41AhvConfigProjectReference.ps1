...
function Initialize-VmmV41AhvConfigProjectReference {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvConfigProjectReference' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigProjectReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvConfigProjectReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvConfigProjectReference
        $AllProperties = ("extId")

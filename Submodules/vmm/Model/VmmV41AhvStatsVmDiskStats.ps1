...
function Initialize-VmmV41AhvStatsVmDiskStats {
    ...
    Process {
        'Creating PSCustomObject: vmm => VmmV41AhvStatsVmDiskStats' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvStatsVmDiskStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: vmm => VmmV41AhvStatsVmDiskStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VmmV41AhvStatsVmDiskStats

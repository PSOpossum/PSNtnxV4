...
function Initialize-UpdateKeyManagementServerById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: security => UpdateKeyManagementServerById4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToUpdateKeyManagementServerById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => UpdateKeyManagementServerById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateKeyManagementServerById4XXResponse

...
function Initialize-SecurityV40ConfigDeleteCredentialApiResponse {
    ...
    Process {
        'Creating PSCustomObject: security => SecurityV40ConfigDeleteCredentialApiResponse' | Write-Debug
...
function ConvertFrom-JsonToSecurityV40ConfigDeleteCredentialApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => SecurityV40ConfigDeleteCredentialApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityV40ConfigDeleteCredentialApiResponse

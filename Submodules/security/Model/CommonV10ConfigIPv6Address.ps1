...
function Initialize-CommonV10ConfigIPv6Address {
    ...
    Process {
        'Creating PSCustomObject: security => CommonV10ConfigIPv6Address' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIPv6Address {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => CommonV10ConfigIPv6Address' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SecurityV40ConfigCreateCredentialApiResponse {
    ...
    Process {
        'Creating PSCustomObject: security => SecurityV40ConfigCreateCredentialApiResponse' | Write-Debug
...
function ConvertFrom-JsonToSecurityV40ConfigCreateCredentialApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => SecurityV40ConfigCreateCredentialApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SecurityV40ConfigCreateCredentialApiResponse

...
function Initialize-UpdateApprovalPolicyByExtId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: security => UpdateApprovalPolicyByExtId4XXResponse' | Write-Debug
...
function ConvertFrom-JsonToUpdateApprovalPolicyByExtId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: security => UpdateApprovalPolicyByExtId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateApprovalPolicyByExtId4XXResponse

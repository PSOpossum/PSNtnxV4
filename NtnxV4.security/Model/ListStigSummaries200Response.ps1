...
function Initialize-NtnxV4ListStigSummaries200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4ListStigSummaries200Response' | Write-Debug
...
Convert from JSON to ListStigSummaries200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListStigSummaries200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4ListStigSummaries200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListStigSummaries200Response

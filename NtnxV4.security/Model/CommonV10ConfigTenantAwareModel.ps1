...
function Initialize-NtnxV4CommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigTenantAwareModel' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigTenantAwareModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigTenantAwareModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-UpdateApprovalPolicyByExtId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4UpdateApprovalPolicyByExtId4XXResponse' | Write-Debug
...
Convert from JSON to UpdateApprovalPolicyByExtId4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToUpdateApprovalPolicyByExtId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4UpdateApprovalPolicyByExtId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateApprovalPolicyByExtId4XXResponse

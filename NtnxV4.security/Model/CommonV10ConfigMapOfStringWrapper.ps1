...
function Initialize-NtnxV4CommonV10ConfigMapOfStringWrapper {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigMapOfStringWrapper' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigMapOfStringWrapper {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigMapOfStringWrapper' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-NtnxV4SecurityV40ConfigCreateCredentialApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigCreateCredentialApiResponse' | Write-Debug
...
Convert from JSON to SecurityV40ConfigCreateCredentialApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToSecurityV40ConfigCreateCredentialApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigCreateCredentialApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4SecurityV40ConfigCreateCredentialApiResponse

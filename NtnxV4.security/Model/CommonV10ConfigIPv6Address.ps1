...
function Initialize-CommonV10ConfigIPv6Address {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigIPv6Address' | Write-Debug
...
function ConvertFrom-JsonToCommonV10ConfigIPv6Address {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigIPv6Address' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

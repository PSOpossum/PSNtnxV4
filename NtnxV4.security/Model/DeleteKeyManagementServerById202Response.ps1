...
function Initialize-NtnxV4DeleteKeyManagementServerById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4DeleteKeyManagementServerById202Response' | Write-Debug
...
Convert from JSON to DeleteKeyManagementServerById202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDeleteKeyManagementServerById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4DeleteKeyManagementServerById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteKeyManagementServerById202Response

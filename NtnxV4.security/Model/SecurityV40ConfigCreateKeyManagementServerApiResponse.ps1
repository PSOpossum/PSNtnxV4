...
function Initialize-NtnxV4SecurityV40ConfigCreateKeyManagementServerApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigCreateKeyManagementServerApiResponse' | Write-Debug
...
Convert from JSON to SecurityV40ConfigCreateKeyManagementServerApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToSecurityV40ConfigCreateKeyManagementServerApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigCreateKeyManagementServerApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4SecurityV40ConfigCreateKeyManagementServerApiResponse

...
function Initialize-NtnxV4SecurityV40ConfigDeleteCredentialApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigDeleteCredentialApiResponse' | Write-Debug
...
Convert from JSON to SecurityV40ConfigDeleteCredentialApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToSecurityV40ConfigDeleteCredentialApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigDeleteCredentialApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4SecurityV40ConfigDeleteCredentialApiResponse

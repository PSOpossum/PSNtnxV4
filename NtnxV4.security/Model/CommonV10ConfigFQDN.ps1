...
function Initialize-NtnxV4CommonV10ConfigFQDN {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigFQDN' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToCommonV10ConfigFQDN {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CommonV10ConfigFQDN' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

...
function Initialize-SecurityV40ConfigDeleteKeyManagementServerApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigDeleteKeyManagementServerApiResponse' | Write-Debug
...
Convert from JSON to SecurityV40ConfigDeleteKeyManagementServerApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToSecurityV40ConfigDeleteKeyManagementServerApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4SecurityV40ConfigDeleteKeyManagementServerApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4SecurityV40ConfigDeleteKeyManagementServerApiResponse

...
function Initialize-NtnxV4CreateApprovalPolicy202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.security => NtnxV4CreateApprovalPolicy202Response' | Write-Debug
...
Convert from JSON to CreateApprovalPolicy202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCreateApprovalPolicy202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.security => NtnxV4CreateApprovalPolicy202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CreateApprovalPolicy202Response

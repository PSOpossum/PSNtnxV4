...
function Initialize-NtnxV4VmmV41AhvStatsVmDiskStats {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvStatsVmDiskStats' | Write-Debug
...
Convert from JSON to VmmV41AhvStatsVmDiskStats<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvStatsVmDiskStats {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvStatsVmDiskStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvStatsVmDiskStats

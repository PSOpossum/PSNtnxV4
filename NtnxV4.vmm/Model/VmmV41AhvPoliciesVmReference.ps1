...
function Initialize-VmmV41AhvPoliciesVmReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesVmReference' | Write-Debug
...
Convert from JSON to VmmV41AhvPoliciesVmReference<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41AhvPoliciesVmReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesVmReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvPoliciesVmReference
        $AllProperties = ("extId")

...
function Initialize-NtnxV4GetNicById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetNicById4XXResponse' | Write-Debug
...
Convert from JSON to GetNicById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetNicById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetNicById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetNicById4XXResponse

...
function Initialize-GetEsxiNicStatsById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetEsxiNicStatsById200Response' | Write-Debug
...
Convert from JSON to GetEsxiNicStatsById200Response<PSCustomObject>
...
function ConvertFrom-JsonToGetEsxiNicStatsById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetEsxiNicStatsById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetEsxiNicStatsById200Response

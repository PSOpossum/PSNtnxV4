...
function Initialize-NtnxV4AssignVmOwner202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4AssignVmOwner202Response' | Write-Debug
...
Convert from JSON to AssignVmOwner202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToAssignVmOwner202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4AssignVmOwner202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4AssignVmOwner202Response

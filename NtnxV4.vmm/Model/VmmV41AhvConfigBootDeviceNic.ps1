...
function Initialize-VmmV41AhvConfigBootDeviceNic {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigBootDeviceNic' | Write-Debug
...
Convert from JSON to VmmV41AhvConfigBootDeviceNic<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41AhvConfigBootDeviceNic {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigBootDeviceNic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigBootDeviceNic

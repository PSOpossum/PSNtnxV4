...
function Initialize-NtnxV4VmmV41EsxiConfigInstallNutanixGuestToolsApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigInstallNutanixGuestToolsApiResponse' | Write-Debug
...
Convert from JSON to VmmV41EsxiConfigInstallNutanixGuestToolsApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41EsxiConfigInstallNutanixGuestToolsApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigInstallNutanixGuestToolsApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41EsxiConfigInstallNutanixGuestToolsApiResponse

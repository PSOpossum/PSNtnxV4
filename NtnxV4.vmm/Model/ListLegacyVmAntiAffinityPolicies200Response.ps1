...
function Initialize-ListLegacyVmAntiAffinityPolicies200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListLegacyVmAntiAffinityPolicies200Response' | Write-Debug
...
Convert from JSON to ListLegacyVmAntiAffinityPolicies200Response<PSCustomObject>
...
function ConvertFrom-JsonToListLegacyVmAntiAffinityPolicies200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListLegacyVmAntiAffinityPolicies200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListLegacyVmAntiAffinityPolicies200Response

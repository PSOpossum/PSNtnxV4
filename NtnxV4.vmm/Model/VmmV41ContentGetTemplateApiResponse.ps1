...
function Initialize-NtnxV4VmmV41ContentGetTemplateApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ContentGetTemplateApiResponse' | Write-Debug
...
Convert from JSON to VmmV41ContentGetTemplateApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41ContentGetTemplateApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ContentGetTemplateApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ContentGetTemplateApiResponse

...
function Initialize-NtnxV4CompleteGuestUpdate202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CompleteGuestUpdate202Response' | Write-Debug
...
Convert from JSON to CompleteGuestUpdate202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCompleteGuestUpdate202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CompleteGuestUpdate202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CompleteGuestUpdate202Response

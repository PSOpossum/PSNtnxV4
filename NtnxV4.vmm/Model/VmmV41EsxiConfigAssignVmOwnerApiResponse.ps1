...
function Initialize-NtnxV4VmmV41EsxiConfigAssignVmOwnerApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigAssignVmOwnerApiResponse' | Write-Debug
...
Convert from JSON to VmmV41EsxiConfigAssignVmOwnerApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41EsxiConfigAssignVmOwnerApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigAssignVmOwnerApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41EsxiConfigAssignVmOwnerApiResponse

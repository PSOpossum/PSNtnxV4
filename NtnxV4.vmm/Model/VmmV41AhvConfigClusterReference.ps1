...
function Initialize-NtnxV4VmmV41AhvConfigClusterReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigClusterReference' | Write-Debug
...
Convert from JSON to VmmV41AhvConfigClusterReference<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvConfigClusterReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigClusterReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigClusterReference
        $AllProperties = ("extId")

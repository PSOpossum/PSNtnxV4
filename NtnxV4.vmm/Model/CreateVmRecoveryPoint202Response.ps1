...
function Initialize-NtnxV4CreateVmRecoveryPoint202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CreateVmRecoveryPoint202Response' | Write-Debug
...
Convert from JSON to CreateVmRecoveryPoint202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCreateVmRecoveryPoint202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CreateVmRecoveryPoint202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CreateVmRecoveryPoint202Response

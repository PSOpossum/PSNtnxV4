...
function Initialize-DeletePlacementPolicyById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeletePlacementPolicyById202Response' | Write-Debug
...
Convert from JSON to DeletePlacementPolicyById202Response<PSCustomObject>
...
function ConvertFrom-JsonToDeletePlacementPolicyById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeletePlacementPolicyById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeletePlacementPolicyById202Response

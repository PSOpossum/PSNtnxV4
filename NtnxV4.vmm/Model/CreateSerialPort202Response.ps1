...
function Initialize-CreateSerialPort202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CreateSerialPort202Response' | Write-Debug
...
Convert from JSON to CreateSerialPort202Response<PSCustomObject>
...
function ConvertFrom-JsonToCreateSerialPort202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CreateSerialPort202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CreateSerialPort202Response

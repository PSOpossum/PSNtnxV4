...
VmmV41ErrorAppMessage<PSCustomObject>
#>

function Initialize-NtnxV4VmmV41ErrorAppMessage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ErrorAppMessage' | Write-Debug
...
Convert from JSON to VmmV41ErrorAppMessage<PSCustomObject>
...
VmmV41ErrorAppMessage<PSCustomObject>
#>
function ConvertFrom-NtnxV4JsonToVmmV41ErrorAppMessage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ErrorAppMessage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ErrorAppMessage

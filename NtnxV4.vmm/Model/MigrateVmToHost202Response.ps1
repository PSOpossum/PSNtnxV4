...
function Initialize-NtnxV4MigrateVmToHost202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4MigrateVmToHost202Response' | Write-Debug
...
Convert from JSON to MigrateVmToHost202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToMigrateVmToHost202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4MigrateVmToHost202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4MigrateVmToHost202Response

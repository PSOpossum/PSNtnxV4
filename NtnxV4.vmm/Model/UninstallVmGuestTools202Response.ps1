...
function Initialize-NtnxV4UninstallVmGuestTools202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4UninstallVmGuestTools202Response' | Write-Debug
...
Convert from JSON to UninstallVmGuestTools202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToUninstallVmGuestTools202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4UninstallVmGuestTools202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UninstallVmGuestTools202Response

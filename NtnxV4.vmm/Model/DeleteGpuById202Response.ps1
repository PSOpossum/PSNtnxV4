...
function Initialize-DeleteGpuById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteGpuById202Response' | Write-Debug
...
Convert from JSON to DeleteGpuById202Response<PSCustomObject>
...
function ConvertFrom-JsonToDeleteGpuById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteGpuById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteGpuById202Response

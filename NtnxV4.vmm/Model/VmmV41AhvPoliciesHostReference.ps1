...
function Initialize-NtnxV4VmmV41AhvPoliciesHostReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesHostReference' | Write-Debug
...
Convert from JSON to VmmV41AhvPoliciesHostReference<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvPoliciesHostReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesHostReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvPoliciesHostReference
        $AllProperties = ("extId")

...
function Initialize-NtnxV4AssignIpById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4AssignIpById4XXResponse' | Write-Debug
...
Convert from JSON to AssignIpById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToAssignIpById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4AssignIpById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4AssignIpById4XXResponse

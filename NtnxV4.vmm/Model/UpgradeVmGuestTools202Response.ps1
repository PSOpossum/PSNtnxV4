...
function Initialize-UpgradeVmGuestTools202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4UpgradeVmGuestTools202Response' | Write-Debug
...
Convert from JSON to UpgradeVmGuestTools202Response<PSCustomObject>
...
function ConvertFrom-JsonToUpgradeVmGuestTools202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4UpgradeVmGuestTools202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpgradeVmGuestTools202Response

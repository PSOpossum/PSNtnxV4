...
function Initialize-NtnxV4DisassociateEsxiCategories202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DisassociateEsxiCategories202Response' | Write-Debug
...
Convert from JSON to DisassociateEsxiCategories202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDisassociateEsxiCategories202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DisassociateEsxiCategories202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DisassociateEsxiCategories202Response

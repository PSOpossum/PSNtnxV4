...
function Initialize-NtnxV4GetVmStatsById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetVmStatsById200Response' | Write-Debug
...
Convert from JSON to GetVmStatsById200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetVmStatsById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetVmStatsById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetVmStatsById200Response

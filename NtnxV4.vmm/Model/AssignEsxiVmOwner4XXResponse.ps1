...
function Initialize-NtnxV4AssignEsxiVmOwner4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4AssignEsxiVmOwner4XXResponse' | Write-Debug
...
Convert from JSON to AssignEsxiVmOwner4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToAssignEsxiVmOwner4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4AssignEsxiVmOwner4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4AssignEsxiVmOwner4XXResponse

...
function Initialize-NtnxV4VmmV41ContentCompleteGuestUpdateApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ContentCompleteGuestUpdateApiResponse' | Write-Debug
...
Convert from JSON to VmmV41ContentCompleteGuestUpdateApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41ContentCompleteGuestUpdateApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ContentCompleteGuestUpdateApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ContentCompleteGuestUpdateApiResponse

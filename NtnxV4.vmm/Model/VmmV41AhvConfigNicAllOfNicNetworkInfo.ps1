...
function Initialize-VmmV41AhvConfigNicAllOfNicNetworkInfo {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigNicAllOfNicNetworkInfo' | Write-Debug
...
function ConvertFrom-JsonToVmmV41AhvConfigNicAllOfNicNetworkInfo {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigNicAllOfNicNetworkInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigNicAllOfNicNetworkInfo

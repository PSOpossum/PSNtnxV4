...
function Initialize-NtnxV4ListVmStats4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListVmStats4XXResponse' | Write-Debug
...
Convert from JSON to ListVmStats4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListVmStats4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListVmStats4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListVmStats4XXResponse

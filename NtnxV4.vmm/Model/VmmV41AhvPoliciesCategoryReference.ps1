...
function Initialize-NtnxV4VmmV41AhvPoliciesCategoryReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesCategoryReference' | Write-Debug
...
Convert from JSON to VmmV41AhvPoliciesCategoryReference<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvPoliciesCategoryReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesCategoryReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvPoliciesCategoryReference
        $AllProperties = ("extId")

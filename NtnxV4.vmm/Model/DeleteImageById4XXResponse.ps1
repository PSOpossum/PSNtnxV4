...
function Initialize-DeleteImageById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteImageById4XXResponse' | Write-Debug
...
Convert from JSON to DeleteImageById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToDeleteImageById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteImageById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteImageById4XXResponse

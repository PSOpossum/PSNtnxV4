...
function Initialize-DeleteCdRomById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteCdRomById4XXResponse' | Write-Debug
...
Convert from JSON to DeleteCdRomById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToDeleteCdRomById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteCdRomById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteCdRomById4XXResponse

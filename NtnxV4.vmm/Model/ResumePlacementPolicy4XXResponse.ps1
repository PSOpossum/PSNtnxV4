...
function Initialize-NtnxV4ResumePlacementPolicy4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ResumePlacementPolicy4XXResponse' | Write-Debug
...
Convert from JSON to ResumePlacementPolicy4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToResumePlacementPolicy4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ResumePlacementPolicy4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ResumePlacementPolicy4XXResponse

...
function Initialize-NtnxV4CloneVm202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CloneVm202Response' | Write-Debug
...
Convert from JSON to CloneVm202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCloneVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CloneVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CloneVm202Response

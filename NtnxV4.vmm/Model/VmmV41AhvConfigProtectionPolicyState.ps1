...
function Initialize-NtnxV4VmmV41AhvConfigProtectionPolicyState {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigProtectionPolicyState' | Write-Debug
...
Convert from JSON to VmmV41AhvConfigProtectionPolicyState<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvConfigProtectionPolicyState {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigProtectionPolicyState' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigProtectionPolicyState

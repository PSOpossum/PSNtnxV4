...
function Initialize-NtnxV4GetEsxiDiskStatsById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetEsxiDiskStatsById200Response' | Write-Debug
...
Convert from JSON to GetEsxiDiskStatsById200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetEsxiDiskStatsById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetEsxiDiskStatsById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetEsxiDiskStatsById200Response

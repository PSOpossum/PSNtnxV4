...
function Initialize-NtnxV4DeleteDiskById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteDiskById4XXResponse' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToDeleteDiskById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteDiskById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

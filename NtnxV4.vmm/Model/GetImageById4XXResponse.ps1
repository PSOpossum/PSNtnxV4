...
function Initialize-NtnxV4GetImageById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetImageById4XXResponse' | Write-Debug
...
Convert from JSON to GetImageById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetImageById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetImageById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetImageById4XXResponse

...
function Initialize-EjectCdRomById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4EjectCdRomById4XXResponse' | Write-Debug
...
Convert from JSON to EjectCdRomById4XXResponse<PSCustomObject>
...
function ConvertFrom-JsonToEjectCdRomById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4EjectCdRomById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4EjectCdRomById4XXResponse

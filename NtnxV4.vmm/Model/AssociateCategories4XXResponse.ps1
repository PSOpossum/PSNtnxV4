...
function Initialize-NtnxV4AssociateCategories4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4AssociateCategories4XXResponse' | Write-Debug
...
Convert from JSON to AssociateCategories4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToAssociateCategories4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4AssociateCategories4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4AssociateCategories4XXResponse

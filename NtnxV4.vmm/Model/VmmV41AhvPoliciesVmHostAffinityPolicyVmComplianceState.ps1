...
function Initialize-VmmV41AhvPoliciesVmHostAffinityPolicyVmComplianceState {
    ...
    Process {
        ...
        if (!$AssociatedCategories -and $AssociatedCategories.length -gt 50) {
            throw "invalid value for 'AssociatedCategories', number of items must be less than or equal to 50."
        }
...
Convert from JSON to VmmV41AhvPoliciesVmHostAffinityPolicyVmComplianceState<PSCustomObject>

...
function Initialize-NtnxV4GetRateLimitPolicyById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetRateLimitPolicyById4XXResponse' | Write-Debug
...
Convert from JSON to GetRateLimitPolicyById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetRateLimitPolicyById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetRateLimitPolicyById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetRateLimitPolicyById4XXResponse

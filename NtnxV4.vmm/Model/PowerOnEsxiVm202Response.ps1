...
function Initialize-PowerOnEsxiVm202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4PowerOnEsxiVm202Response' | Write-Debug
...
Convert from JSON to PowerOnEsxiVm202Response<PSCustomObject>
...
function ConvertFrom-JsonToPowerOnEsxiVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4PowerOnEsxiVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4PowerOnEsxiVm202Response

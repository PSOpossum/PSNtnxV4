...
function Initialize-NtnxV4VmmV41AhvPoliciesClusterReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesClusterReference' | Write-Debug
...
Convert from JSON to VmmV41AhvPoliciesClusterReference<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvPoliciesClusterReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesClusterReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvPoliciesClusterReference
        $AllProperties = ("extId")

...
function Initialize-UpdateImageById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4UpdateImageById202Response' | Write-Debug
...
Convert from JSON to UpdateImageById202Response<PSCustomObject>
...
function ConvertFrom-JsonToUpdateImageById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4UpdateImageById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpdateImageById202Response

...
function Initialize-NtnxV4VmmV41AhvPoliciesUserReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesUserReference' | Write-Debug
...
Convert from JSON to VmmV41AhvPoliciesUserReference<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvPoliciesUserReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvPoliciesUserReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvPoliciesUserReference
        $AllProperties = ("extId")

...
function Initialize-NtnxV4DeleteLegacyVmAntiAffinityPolicyById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteLegacyVmAntiAffinityPolicyById202Response' | Write-Debug
...
Convert from JSON to DeleteLegacyVmAntiAffinityPolicyById202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDeleteLegacyVmAntiAffinityPolicyById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteLegacyVmAntiAffinityPolicyById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteLegacyVmAntiAffinityPolicyById202Response

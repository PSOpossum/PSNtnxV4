...
ResetVm4XXResponse<PSCustomObject>
#>

function Initialize-NtnxV4ResetVm4XXResponse {
    [CmdletBinding()]
    Param (
...
Convert from JSON to ResetVm4XXResponse<PSCustomObject>
...
ResetVm4XXResponse<PSCustomObject>
#>
function ConvertFrom-NtnxV4JsonToResetVm4XXResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )

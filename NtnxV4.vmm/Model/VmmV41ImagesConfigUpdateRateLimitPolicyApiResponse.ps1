...
function Initialize-NtnxV4VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse' | Write-Debug
...
Convert from JSON to VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41ImagesConfigUpdateRateLimitPolicyApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41ImagesConfigUpdateRateLimitPolicyApiResponse

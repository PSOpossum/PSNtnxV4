...
function Initialize-NtnxV4VmmV41AhvConfigUserdata {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigUserdata' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvConfigUserdata {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigUserdata' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

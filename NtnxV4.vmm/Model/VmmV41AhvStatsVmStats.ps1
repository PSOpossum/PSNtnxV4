...
VmmV41AhvStatsVmStats<PSCustomObject>
#>

function Initialize-NtnxV4VmmV41AhvStatsVmStats {
    [CmdletBinding()]
    Param (
...
Convert from JSON to VmmV41AhvStatsVmStats<PSCustomObject>
...
VmmV41AhvStatsVmStats<PSCustomObject>
#>
function ConvertFrom-NtnxV4JsonToVmmV41AhvStatsVmStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )

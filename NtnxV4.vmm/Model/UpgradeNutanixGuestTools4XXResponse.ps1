...
function Initialize-NtnxV4UpgradeNutanixGuestTools4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4UpgradeNutanixGuestTools4XXResponse' | Write-Debug
...
Convert from JSON to UpgradeNutanixGuestTools4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToUpgradeNutanixGuestTools4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4UpgradeNutanixGuestTools4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UpgradeNutanixGuestTools4XXResponse

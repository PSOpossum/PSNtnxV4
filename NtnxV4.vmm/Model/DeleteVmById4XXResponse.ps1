...
function Initialize-NtnxV4DeleteVmById4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteVmById4XXResponse' | Write-Debug
...
Convert from JSON to DeleteVmById4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDeleteVmById4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteVmById4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteVmById4XXResponse

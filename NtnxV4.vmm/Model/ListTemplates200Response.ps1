...
function Initialize-NtnxV4ListTemplates200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListTemplates200Response' | Write-Debug
...
Convert from JSON to ListTemplates200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListTemplates200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListTemplates200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListTemplates200Response

...
function Initialize-NtnxV4DeleteVmHostAffinityPolicyById202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4DeleteVmHostAffinityPolicyById202Response' | Write-Debug
...
Convert from JSON to DeleteVmHostAffinityPolicyById202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToDeleteVmHostAffinityPolicyById202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4DeleteVmHostAffinityPolicyById202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4DeleteVmHostAffinityPolicyById202Response

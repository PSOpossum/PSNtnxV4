...
VmmV41EsxiStatsVmStats<PSCustomObject>
#>

function Initialize-NtnxV4VmmV41EsxiStatsVmStats {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiStatsVmStats' | Write-Debug
...
Convert from JSON to VmmV41EsxiStatsVmStats<PSCustomObject>
...
VmmV41EsxiStatsVmStats<PSCustomObject>
#>
function ConvertFrom-NtnxV4JsonToVmmV41EsxiStatsVmStats {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiStatsVmStats' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41EsxiStatsVmStats

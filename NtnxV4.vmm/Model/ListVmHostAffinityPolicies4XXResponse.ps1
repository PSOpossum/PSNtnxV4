...
function Initialize-NtnxV4ListVmHostAffinityPolicies4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListVmHostAffinityPolicies4XXResponse' | Write-Debug
...
Convert from JSON to ListVmHostAffinityPolicies4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListVmHostAffinityPolicies4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListVmHostAffinityPolicies4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListVmHostAffinityPolicies4XXResponse

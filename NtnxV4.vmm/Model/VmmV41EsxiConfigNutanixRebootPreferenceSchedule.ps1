...
function Initialize-VmmV41EsxiConfigNutanixRebootPreferenceSchedule {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigNutanixRebootPreferenceSchedule' | Write-Debug
...
Convert from JSON to VmmV41EsxiConfigNutanixRebootPreferenceSchedule<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41EsxiConfigNutanixRebootPreferenceSchedule {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigNutanixRebootPreferenceSchedule' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41EsxiConfigNutanixRebootPreferenceSchedule

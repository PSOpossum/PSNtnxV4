...
function Initialize-NtnxV4CreateCdRom202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CreateCdRom202Response' | Write-Debug
...
Convert from JSON to CreateCdRom202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToCreateCdRom202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CreateCdRom202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CreateCdRom202Response

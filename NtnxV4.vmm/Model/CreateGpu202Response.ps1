...
function Initialize-CreateGpu202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4CreateGpu202Response' | Write-Debug
...
Convert from JSON to CreateGpu202Response<PSCustomObject>
...
function ConvertFrom-JsonToCreateGpu202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4CreateGpu202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4CreateGpu202Response

...
function Initialize-NtnxV4ListSerialPortsByVmId4XXResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListSerialPortsByVmId4XXResponse' | Write-Debug
...
Convert from JSON to ListSerialPortsByVmId4XXResponse<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToListSerialPortsByVmId4XXResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListSerialPortsByVmId4XXResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListSerialPortsByVmId4XXResponse

...
function Initialize-NtnxV4RebootVm202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4RebootVm202Response' | Write-Debug
...
Convert from JSON to RebootVm202Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToRebootVm202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4RebootVm202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4RebootVm202Response

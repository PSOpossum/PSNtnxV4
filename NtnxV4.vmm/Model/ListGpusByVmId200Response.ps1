...
function Initialize-ListGpusByVmId200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4ListGpusByVmId200Response' | Write-Debug
...
Convert from JSON to ListGpusByVmId200Response<PSCustomObject>
...
function ConvertFrom-JsonToListGpusByVmId200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4ListGpusByVmId200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4ListGpusByVmId200Response

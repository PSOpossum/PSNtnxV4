...
function Initialize-NtnxV4UninstallNutanixGuestTools202Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4UninstallNutanixGuestTools202Response' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToUninstallNutanixGuestTools202Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4UninstallNutanixGuestTools202Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4UninstallNutanixGuestTools202Response

...
function Initialize-NtnxV4VmmV41AhvConfigProjectReference {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigProjectReference' | Write-Debug
...
Convert from JSON to VmmV41AhvConfigProjectReference<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvConfigProjectReference {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigProjectReference' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41AhvConfigProjectReference
        $AllProperties = ("extId")

...
function Initialize-NtnxV4GetTemplateById200Response {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4GetTemplateById200Response' | Write-Debug
...
Convert from JSON to GetTemplateById200Response<PSCustomObject>
...
function ConvertFrom-NtnxV4JsonToGetTemplateById200Response {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4GetTemplateById200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4GetTemplateById200Response

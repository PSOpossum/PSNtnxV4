...
function Initialize-VmmV41EsxiConfigRebootGuestOSApiResponse {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigRebootGuestOSApiResponse' | Write-Debug
...
Convert from JSON to VmmV41EsxiConfigRebootGuestOSApiResponse<PSCustomObject>
...
function ConvertFrom-JsonToVmmV41EsxiConfigRebootGuestOSApiResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41EsxiConfigRebootGuestOSApiResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in NtnxV4VmmV41EsxiConfigRebootGuestOSApiResponse

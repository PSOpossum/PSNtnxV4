...
function Initialize-NtnxV4VmmV41AhvConfigCloudInit {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigCloudInit' | Write-Debug
...
function ConvertFrom-NtnxV4JsonToVmmV41AhvConfigCloudInit {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4VmmV41AhvConfigCloudInit' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

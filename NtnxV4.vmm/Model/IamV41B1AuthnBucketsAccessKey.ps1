...
function Initialize-IamV41B1AuthnBucketsAccessKey {
    ...
    Process {
        'Creating PSCustomObject: NtnxV4.vmm => NtnxV4IamV41B1AuthnBucketsAccessKey' | Write-Debug
...
function ConvertFrom-JsonToIamV41B1AuthnBucketsAccessKey {
    ...
    Process {
        'Converting JSON to PSCustomObject: NtnxV4.vmm => NtnxV4IamV41B1AuthnBucketsAccessKey' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
